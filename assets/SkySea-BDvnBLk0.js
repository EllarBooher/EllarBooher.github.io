var ce=Object.defineProperty;var de=(c,e,t)=>e in c?ce(c,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):c[e]=t;var r=(c,e,t)=>de(c,typeof e!="symbol"?e+"":e,t);import{m as v,v as M,a as w,b as T}from"./wgpu-matrix.module-BO3i1RYM.js";const se=4;class P{constructor(e,t,a){r(this,"buffer");this.buffer=e.createBuffer({size:t*se,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.UNIFORM,label:a})}writeToGPU(e){const t=this.packed();t.byteLength!=this.buffer.size&&console.warn(`GPUBuffer label: '${this.buffer.label}' uploaded with improper size. Expected: ${this.buffer.size} bytes, got ${t.byteLength} bytes.`),e.writeBuffer(this.buffer,0,t)}}function _e(){return{rayleighMm:{scattering:w.create(5.802,13.558,33.1),absorption:w.create(0,0,0),densityScale:.008},mieMm:{scattering:w.create(3.996,3.996,3.996),absorption:w.create(4.4,4.4,4.4),densityScale:.0012},ozoneMm:{scattering:w.create(0,0,0),absorption:w.create(.65,1.881,.085)},planetRadiusMm:6.36,atmosphereRadiusMm:6.42,groundAlbedo:w.create(.3*1,.3*.75,.3*.4)}}function me(){return{color:w.create(1,1,1),strength:60,forward:w.create(0,-1,0),angularRadius:16/60*(3.141592653589793/180)}}const pe=16,he=128,fe=16,ge=32,ve=16,H=256,ye=16,be=16;function xe(c,e){return Math.ceil(e/c)*c}const we=Math.max(pe,fe,ve,ye),Te=xe(we,H+H+he+ge+be);class Se extends P{constructor(t){super(t,Te/se,"Global UBO");r(this,"data",{atmosphere:_e(),light:me(),camera:{invProj:v.identity(),invView:v.identity(),projView:v.identity(),position:M.create(0,0,0,1),forward:M.create(0,0,-1,0)},ocean_camera:{invProj:v.identity(),invView:v.identity(),projView:v.identity(),position:M.create(0,0,0,1),forward:M.create(0,0,-1,0)},time:{timeSeconds:0,deltaTimeSeconds:0}})}packed(){const t=new Float32Array(2).fill(0),a=new Float32Array(4).fill(0),i=new Float32Array(4*2).fill(0),n=this.data.atmosphere,s=n.rayleighMm,o=n.mieMm,l=new Float32Array([...s.scattering,s.densityScale,...s.absorption,n.planetRadiusMm,...o.scattering,o.densityScale,...o.absorption,n.atmosphereRadiusMm,...n.groundAlbedo,0,...n.ozoneMm.scattering,0,...n.ozoneMm.absorption,0,...a]),u=this.data.light,_=new Float32Array([...u.color,u.strength,...u.forward,u.angularRadius]),p=this.data.camera,y=new Float32Array([...p.invProj,...p.invView,...p.projView,...p.position,...p.forward,...i]),g=this.data.ocean_camera,m=new Float32Array([...g.invProj,...g.invView,...g.projView,...g.position,...g.forward,...i]),b=this.data.time,d=new Float32Array([...t,b.timeSeconds,b.deltaTimeSeconds]);return new Float32Array([...y,...m,...l,..._,...d])}}const Me=`// Sizeof(Atmosphere) = 8 * 16 = 128
...
`,j="rgba32float";class Pe{constructor(e,t,a,i,n){r(this,"texture");r(this,"view");r(this,"pipeline");r(this,"group0");r(this,"group1");const s="Multiscatter LUT";this.texture=e.createTexture({size:t,dimension:"2d",format:j,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING,label:"Multiscatter LUT"}),this.view=this.texture.createView({label:s});const o=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,storageTexture:{access:"write-only",format:j}},{binding:1,visibility:GPUShaderStage.COMPUTE,sampler:{type:i?"filtering":"non-filtering"}},{binding:2,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:i?"float":"unfilterable-float"}}],label:"Multiscatter LUT Group 0"});this.group0=e.createBindGroup({layout:o,entries:[{binding:0,resource:this.view},{binding:1,resource:e.createSampler({magFilter:i?"linear":"nearest",minFilter:i?"linear":"nearest"})},{binding:2,resource:a}],label:"Multiscatter LUT Group 0"});const l=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{}}],label:"Multiscatter LUT Group 1"});this.group1=e.createBindGroup({layout:l,entries:[{binding:0,resource:{buffer:n.buffer}}],label:"Multiscatter LUT Group 1"});const u=e.createShaderModule({code:De,label:s});this.pipeline=e.createComputePipeline({compute:{module:u,entryPoint:"computeMultiscattering"},layout:e.createPipelineLayout({bindGroupLayouts:[o,l]}),label:"Multiscatter LUT"})}record(e){const t=e.beginComputePass({label:"Multiscatter LUT"});t.setPipeline(this.pipeline),t.setBindGroup(0,this.group0),t.setBindGroup(1,this.group1),t.dispatchWorkgroups(Math.ceil(this.texture.width/16),Math.ceil(this.texture.height/16)),t.end()}}const Ue=`// Sizeof(Atmosphere) = 8 * 16 = 128
// Alignof(Atmosphere) = 16
struct Atmosphere
{
    scattering_rayleigh_per_Mm : vec3<f32>,
...
`,Y="rgba32float";class Re{constructor(e,t,a,i,n,s){r(this,"texture");r(this,"view");r(this,"group0");r(this,"group1");r(this,"pipeline");this.texture=e.createTexture({size:t,dimension:"2d",format:Y,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING,label:"Skyview LUT"}),this.view=this.texture.createView({label:"Skyview LUT"});const o=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,storageTexture:{access:"write-only",format:Y}},{binding:1,visibility:GPUShaderStage.COMPUTE,sampler:{type:n?"filtering":"non-filtering"}},{binding:2,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:n?"float":"unfilterable-float"}},{binding:3,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:n?"float":"unfilterable-float"}}],label:"Skyview LUT"});this.group0=e.createBindGroup({layout:o,entries:[{binding:0,resource:this.view},{binding:1,resource:e.createSampler({magFilter:n?"linear":"nearest",minFilter:n?"linear":"nearest"})},{binding:2,resource:a},{binding:3,resource:i}],label:"Skyview LUT Group 0"});const l=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{}}],label:"Skyview LUT Group 1"});this.group1=e.createBindGroup({layout:l,entries:[{binding:0,resource:{buffer:s.buffer}}],label:"Skyview LUT Group 1"});const u=e.createShaderModule({code:Ue});this.pipeline=e.createComputePipeline({compute:{module:u,entryPoint:"computeSkyViewLuminance"},layout:e.createPipelineLayout({bindGroupLayouts:[o,l]}),label:"Skyview LUT"})}record(e,t){const a=e.beginComputePass({timestampWrites:t!==void 0?{querySet:t.querySet,beginningOfPassWriteIndex:t.beginWriteIndex,endOfPassWriteIndex:t.endWriteIndex}:void 0,label:"Skyview LUT"});a.setPipeline(this.pipeline),a.setBindGroup(0,this.group0),a.setBindGroup(1,this.group1),a.dispatchWorkgroups(Math.ceil(this.texture.width/16),Math.ceil(this.texture.height/(16*1.9))),a.end()}}const Ee=`// Sizeof(Atmosphere) = 8 * 16 = 128
// Alignof(Atmosphere) = 16
struct Atmosphere
{
    scattering_rayleigh_per_Mm : vec3<f32>,
...
`,X="rgba16float";class Le{constructor(e,t,a,i,n,s,o,l){r(this,"group0Layout");r(this,"group1Layout");r(this,"lutSampler");r(this,"group0");r(this,"group1");r(this,"outputColor");r(this,"outputColorView");r(this,"pipeline");this.group0Layout=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:X}},{binding:1,visibility:GPUShaderStage.COMPUTE,sampler:{type:o?"filtering":"non-filtering"}},{binding:2,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:o?"float":"unfilterable-float",viewDimension:"2d"}},{binding:3,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:o?"float":"unfilterable-float",viewDimension:"2d"}},{binding:4,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:o?"float":"unfilterable-float",viewDimension:"2d"}},{binding:5,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float",viewDimension:"3d"}}],label:"Atmosphere Camera Group 0"}),this.group1Layout=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{}}],label:"Atmosphere Camera Group 1"}),this.outputColor=e.createTexture({format:X,size:{width:1,height:1},usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING,label:"Atmosphere Camera Output Color"}),this.outputColorView=this.outputColor.createView(),this.lutSampler=e.createSampler({label:"Atmosphere Camera LUT Sampler",magFilter:o?"linear":"nearest",minFilter:o?"linear":"nearest"}),this.group0=e.createBindGroup({layout:this.group0Layout,entries:[{binding:0,resource:this.outputColorView},{binding:1,resource:this.lutSampler},{binding:2,resource:a},{binding:3,resource:i},{binding:4,resource:n},{binding:5,resource:s}],label:"Atmosphere Camera Group 0"}),this.group1=e.createBindGroup({layout:this.group1Layout,entries:[{binding:0,resource:{buffer:l.buffer}}],label:"Atmosphere Camera Group 1"});const u=e.createShaderModule({code:Ee,label:"Atmosphere Camera"});this.pipeline=e.createComputePipeline({compute:{module:u,entryPoint:"renderCompositedAtmosphere"},layout:e.createPipelineLayout({bindGroupLayouts:[this.group0Layout,this.group1Layout,t]}),label:"Atmosphere Camera"})}resize(e,t,a,i,n,s){this.outputColor=t.createTexture({format:this.outputColor.format,size:e,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING}),this.outputColorView=this.outputColor.createView(),this.group0=t.createBindGroup({layout:this.group0Layout,entries:[{binding:0,resource:this.outputColorView},{binding:1,resource:this.lutSampler},{binding:2,resource:a},{binding:3,resource:i},{binding:4,resource:n},{binding:5,resource:s}],label:"Atmosphere Camera Group 0 Resized"})}record(e,t,a){const i=e.beginComputePass({timestampWrites:t!==void 0?{querySet:t.querySet,beginningOfPassWriteIndex:t.beginWriteIndex,endOfPassWriteIndex:t.endWriteIndex}:void 0,label:"Atmosphere Camera"});i.setPipeline(this.pipeline),i.setBindGroup(0,this.group0),i.setBindGroup(1,this.group1),i.setBindGroup(2,a.readGroup),i.dispatchWorkgroups(Math.ceil(this.outputColor.width/16),Math.ceil(this.outputColor.height/16)),i.end()}}const Ce=`const PI = 3.141592653589793;
const METERS_PER_MM = 1000000;
...
`,Ve=`const TWO_PI = 6.28318530717958647693;
...
`;class He extends P{constructor(t){super(t,3,"DFFT Parameters UBO");r(this,"data",{log_2_size:1,size:2,b_inverse:!1})}packed(){const t=new ArrayBuffer(this.buffer.size),a=new DataView(t);return a.setUint32(0,this.data.log_2_size,!0),a.setUint32(4,this.data.size,!0),a.setFloat32(8,this.data.b_inverse?1:0,!0),t}}const J=16,C="rgba16float";class je{constructor(e,t,a){r(this,"parametersUBO");r(this,"intermediateDFTs");r(this,"gridSize3D");r(this,"complexBuffer0");r(this,"complexBuffer1");r(this,"stepCounterBuffer");r(this,"outputTexture");r(this,"intermediateDFTsBindGroup");r(this,"intermediateDFTsKernel");r(this,"performBindGroup");r(this,"performKernel");r(this,"performSwapEvenSignsAndCopyToHalfPrecisionOutputKernel");r(this,"stepCounterBindGroup");r(this,"incrementStepCounterKernel");r(this,"resetStepCounterKernel");if(t<5)throw new RangeError("gridSizeExponent must be greater than 4.");if(!Number.isFinite(a)||a<1)throw new RangeError(`layerCount of ${a} is invalid`);const i=Math.pow(2,t);this.gridSize3D={width:i,height:i,depthOrArrayLayers:a};const n=this.gridSize3D.width*this.gridSize3D.height*this.gridSize3D.depthOrArrayLayers;this.parametersUBO=new He(e),this.parametersUBO.data.log_2_size=t,this.parametersUBO.data.size=i,this.parametersUBO.data.b_inverse=!1,this.parametersUBO.writeToGPU(e.queue);const s=16;this.intermediateDFTs=e.createBuffer({label:"DFFT Precompute Stage Steps",size:t*i*s,usage:GPUBufferUsage.STORAGE});const o=e.createShaderModule({label:"DFFT Precompute Stage",code:Ve}),l=e.createBindGroupLayout({label:"DFFT Precompute Stage Group 0",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]});this.intermediateDFTsBindGroup=e.createBindGroup({label:"DFFT Precompute Stage Group 0",layout:l,entries:[{binding:0,resource:{buffer:this.parametersUBO.buffer}},{binding:1,resource:{buffer:this.intermediateDFTs}}]});const u=e.createPipelineLayout({label:"DFFT Precompute Steps Kernel",bindGroupLayouts:[l]});this.intermediateDFTsKernel=e.createComputePipeline({label:"DFFT Precompute Stage",compute:{module:o,entryPoint:"precomputeDFFTInstructions"},layout:u});const _=e.createBindGroupLayout({label:"DFFT Perform Group 0",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:4,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:5,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:C,viewDimension:"2d-array",access:"write-only"}}]});this.complexBuffer0=e.createBuffer({label:"DFFT Buffer 0",size:n*J,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),this.complexBuffer1=e.createBuffer({label:"DFFT Buffer 1",size:this.complexBuffer0.size,usage:this.complexBuffer0.usage});const p=4;this.stepCounterBuffer=e.createBuffer({label:"DFFT Step Counter",size:p,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.STORAGE|GPUBufferUsage.UNIFORM});const y=new Uint32Array(1);y[0]=0,e.queue.writeBuffer(this.stepCounterBuffer,0,y),this.outputTexture=e.createTexture({label:"DFFT Output Texture",format:C,size:this.gridSize3D,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.COPY_SRC}),this.performBindGroup=e.createBindGroup({label:"DFFT Perform Group 0",layout:_,entries:[{binding:0,resource:{buffer:this.parametersUBO.buffer}},{binding:1,resource:{buffer:this.intermediateDFTs}},{binding:2,resource:{buffer:this.complexBuffer0}},{binding:3,resource:{buffer:this.complexBuffer1}},{binding:4,resource:{buffer:this.stepCounterBuffer}},{binding:5,resource:this.outputTexture.createView()}]});const g=e.createPipelineLayout({label:"DFFT Perform",bindGroupLayouts:[_]});this.performKernel=e.createComputePipeline({label:"DFFT Perform DFFT Step",compute:{module:o,entryPoint:"performDFFTStep"},layout:g}),this.performSwapEvenSignsAndCopyToHalfPrecisionOutputKernel=e.createComputePipeline({label:"DFFT Perform Swap Even Signs",compute:{module:o,entryPoint:"performSwapEvenSignsAndCopyToHalfPrecisionOutput"},layout:g});const m=e.createBindGroupLayout({label:"DFFT Step Counter Bind Group 0",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]});this.stepCounterBindGroup=e.createBindGroup({label:"DFFT Step Counter Bind Group 0",layout:m,entries:[{binding:0,resource:{buffer:this.stepCounterBuffer}}]});const b=e.createPipelineLayout({label:"DFFT Step Counter",bindGroupLayouts:[m]});this.incrementStepCounterKernel=e.createComputePipeline({label:"DFFT Increment Step Counter Kernel",layout:b,compute:{module:o,entryPoint:"incrementStepCounter"}}),this.resetStepCounterKernel=e.createComputePipeline({label:"DFFT Reset Step Counter Kernel",layout:b,compute:{module:o,entryPoint:"resetStepCounter"}}),this.parametersUBO.data.b_inverse=!0,this.parametersUBO.writeToGPU(e.queue);const d=e.createCommandEncoder({label:"DFFT Precompute"}),h=d.beginComputePass({label:"DFFT Precompute Steps"});h.setPipeline(this.intermediateDFTsKernel),h.setBindGroup(0,this.intermediateDFTsBindGroup),h.dispatchWorkgroups(i/2/2,1),h.end(),e.queue.submit([d.finish()])}recordPerformOnBuffer0(e,t){const a=2*this.parametersUBO.data.log_2_size,i=e.beginComputePass({label:"DFFT Perform",timestampWrites:t});for(let n=0;n<a;n++)n===0?(i.setPipeline(this.resetStepCounterKernel),i.setBindGroup(0,this.stepCounterBindGroup),i.dispatchWorkgroups(1)):(i.setPipeline(this.incrementStepCounterKernel),i.setBindGroup(0,this.stepCounterBindGroup),i.dispatchWorkgroups(1)),i.setPipeline(this.performKernel),i.setBindGroup(0,this.performBindGroup),i.dispatchWorkgroups(this.gridSize3D.width/16,this.gridSize3D.height/16,this.gridSize3D.depthOrArrayLayers/1);i.setPipeline(this.performSwapEvenSignsAndCopyToHalfPrecisionOutputKernel),i.setBindGroup(0,this.performBindGroup),i.dispatchWorkgroups(this.gridSize3D.width/16,this.gridSize3D.height/16,this.gridSize3D.depthOrArrayLayers/1),i.end()}recordPerform(e,t,a,i,n,s){const o="rgba32float";if(a.format!=o)throw RangeError(`sourceTexture (format ${a.format}) must be ${o}`);if(i.format!=C)throw RangeError(`destinationArray (format ${a.format}) must be ${o}`);if(a.width!=i.width||a.height!=i.height||a.depthOrArrayLayers!=i.depthOrArrayLayers)throw RangeError(`SourceTexture ${a.label} does not match destination texture ${i.label} extent`);this.parametersUBO.data.b_inverse=n,this.parametersUBO.writeToGPU(e.queue),t.copyTextureToBuffer({texture:a},{buffer:this.complexBuffer0,bytesPerRow:this.gridSize3D.width*J,rowsPerImage:this.gridSize3D.height},this.gridSize3D),this.recordPerformOnBuffer0(t,s),t.copyTextureToTexture({texture:this.outputTexture},{texture:i},this.gridSize3D)}}const Ye=`@group(0) @binding(0) var out_next_mip_level: texture_storage_2d_array<rgba16float, write>;
...
`,I="rgba16float";class Xe{constructor(e){r(this,"fillMipMapTextureInOutLayout");r(this,"fillMipMapKernel");r(this,"fillMipMapSmallerKernel");this.fillMipMapTextureInOutLayout=e.createBindGroupLayout({label:"MipMap Generation fillMipMap Texture In-Out",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:I,viewDimension:"2d-array"}},{binding:1,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}]});const t=e.createShaderModule({label:"sky-sea/mipmap.wgsl",code:Ye}),a=e.createPipelineLayout({label:"MipMap Generation fillMipMap Kernel",bindGroupLayouts:[this.fillMipMapTextureInOutLayout]});this.fillMipMapKernel=e.createComputePipeline({label:"MipMap Generation fillMipMap Kernel",layout:a,compute:{module:t,entryPoint:"fillMipMap"}}),this.fillMipMapSmallerKernel=e.createComputePipeline({label:"MipMap Generation fillMipMapSmaller Kernel",layout:a,compute:{module:t,entryPoint:"fillMipMapSmaller"}})}createBindGroups(e,t){if(t.format!=I)throw new RangeError(`Invalid source texture (label ${t.label}) for MipMap generation`,{cause:`Source format is ${t.format} when expected ${I}`});if(t.dimension!="2d")throw new RangeError(`Invalid source texture (label ${t.label}) for MipMap generation`,{cause:"Source texture is not 2d"});if(!(t.usage&GPUTextureUsage.COPY_SRC))throw new RangeError(`Invalid source texture (label ${t.label}) for MipMap generation`,{cause:"Source usage is missing required flag COPY_SRC"});if(t.width!=t.height||!Number.isInteger(Math.log2(t.width)))throw new RangeError(`Invalid source texture (label ${t.label}) for MipMap generation`,{cause:`Source dimensions of (${t.width},${t.height}) are invalid, texture must be square and power-of-2.`});const a=Math.log2(t.width);return{level0Size:{width:t.width,height:t.height},bindGroupsByMipLevel:[...new Array(Math.min(a,t.mipLevelCount)-1).keys()].map((i,n)=>{const s=n+1,o=n;return e.createBindGroup({label:`MipMap Generation for '${t.label}' IO Bind Group '${o} => ${s}'`,layout:this.fillMipMapTextureInOutLayout,entries:[{binding:0,resource:t.createView({dimension:"2d-array",baseMipLevel:s,mipLevelCount:1})},{binding:1,resource:t.createView({dimension:"2d-array",baseMipLevel:o,mipLevelCount:1})}]})}),arrayLevelCount:t.depthOrArrayLayers}}recordUpdateMipMaps(e,t){t.bindGroupsByMipLevel.forEach((a,i)=>{e.setBindGroup(0,a);const n=1<<i,s=t.level0Size.width/n,o=t.level0Size.height/n;s>=16&&o>=16?(e.setPipeline(this.fillMipMapKernel),e.dispatchWorkgroups(s/16,o/16,t.arrayLevelCount)):(e.setPipeline(this.fillMipMapSmallerKernel),e.dispatchWorkgroups(s,o,t.arrayLevelCount))})}}const oe=512,O=9,Qe=9.8,Ke=100,Ze="rg32float",ee="rg32float",$e="rgba16float",te="rgba16float",G="rgba32float",Je=4,ae=4;class et extends P{constructor(t){super(t,8+Je*ae,"Fourier Waves UBO");r(this,"data",{fourier_grid_size:oe,gravity:Qe,padding0:0,wave_period_seconds:Ke,wind_speed_meters_per_second:10,wind_fetch_meters:10*1e3,wave_swell:.3,padding1:0,cascades:new Array(4)})}packed(){const t=new ArrayBuffer(this.buffer.size),a=new DataView(t),i=new Float32Array(t);a.setUint32(0,this.data.fourier_grid_size,!0),a.setFloat32(4,this.data.gravity,!0),a.setFloat32(8,this.data.padding0,!0),a.setFloat32(12,this.data.wave_period_seconds,!0),a.setFloat32(16,this.data.wind_speed_meters_per_second,!0),a.setFloat32(20,this.data.wind_fetch_meters,!0),a.setFloat32(24,this.data.wave_swell,!0),a.setFloat32(28,this.data.padding1,!0);const n=8;return this.data.cascades.forEach((s,o)=>{const l=n+o*ae;i.set(s.wave_number_min_max,l),i[l+2]=s.wave_patch_extent_meters,i[l+3]=0}),t}}function tt(){const c=Math.random(),e=Math.random(),t=Math.sqrt(-2*Math.log(c)),a=2*Math.PI*e,i=t*Math.cos(a),n=t*Math.sin(a);return[i,n]}class at{constructor(e,t,a){r(this,"Dx_Dy_Dz_Dxdz_Spatial");r(this,"Dydx_Dydz_Dxdx_Dzdz_Spatial");r(this,"turbulenceJacobian");r(this,"Dx_Dy_Dz_Dxdz_SpatialAllMips");r(this,"Dydx_Dydz_Dxdx_Dzdz_SpatialAllMips");r(this,"turbulenceJacobianOneMip");e.mipLevelCount!=t.mipLevelCount&&console.warn(`FFT Wave Displacement maps do not have identical mip levels. ${e.mipLevelCount} vs ${t.mipLevelCount}`),this.Dx_Dy_Dz_Dxdz_Spatial=e,this.Dydx_Dydz_Dxdx_Dzdz_Spatial=t,this.turbulenceJacobian=a,this.Dx_Dy_Dz_Dxdz_SpatialAllMips=this.Dx_Dy_Dz_Dxdz_Spatial.createView({label:`FFT Wave DisplacementMaps for ${this.Dx_Dy_Dz_Dxdz_Spatial.label}`}),this.Dydx_Dydz_Dxdx_Dzdz_SpatialAllMips=this.Dydx_Dydz_Dxdx_Dzdz_Spatial.createView({label:`FFT Wave DisplacementMaps for ${this.Dydx_Dydz_Dxdx_Dzdz_Spatial.label}`}),this.turbulenceJacobianOneMip=this.turbulenceJacobian.map((i,n)=>i.createView({label:`FFT Wave DisplacementMaps for ${this.turbulenceJacobian[n].label} index ${n}`}))}get mipLevelCount(){return this.Dx_Dy_Dz_Dxdz_Spatial.mipLevelCount}}class rt{constructor(e,t){r(this,"gridSize");r(this,"cascadeCount");r(this,"initialAmplitudeKernel");r(this,"realizedAmplitudeKernel");r(this,"accumulateTurbulenceKernel");r(this,"dfftResources");r(this,"mipMapGenerator");r(this,"cascades");r(this,"Dx_Dy_Dz_Dxdz_SpatialArray");r(this,"Dydx_Dydz_Dxdx_Dzdz_SpatialArray");r(this,"turbulenceJacobianArrays");r(this,"turbulenceJacobianIndex",0);r(this,"Dx_Dy_Dz_Dxdz_SpatialArray_MipMapBindings");r(this,"Dydx_Dydz_Dxdx_Dzdz_SpatialArray_MipMapBindings");r(this,"waveSettings");this.gridSize=oe;const a=e.createBindGroupLayout({label:"FFT Wave Initial Amplitude h_0(k) Group 0",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:ee,viewDimension:"2d-array",access:"write-only"}},{binding:1,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}]}),i=e.createBindGroupLayout({label:"FFT Wave Initial Amplitude h_0(k) Group 1",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),n=e.createShaderModule({label:"FFT Wave",code:We});this.initialAmplitudeKernel=e.createComputePipeline({label:"FFT Wave Initial Amplitude h_0(k)",layout:e.createPipelineLayout({label:"FFT Wave Initial Amplitude h_0(k)",bindGroupLayouts:[a,i]}),compute:{module:n,entryPoint:"computeInitialAmplitude"}}),this.mipMapGenerator=new Xe(e);const s=e.createBindGroupLayout({label:"FFT Wave Realized Fourier Amplitude h(k,t) Group 0",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:G,viewDimension:"2d-array",access:"write-only"}},{binding:1,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:G,viewDimension:"2d-array",access:"write-only"}},{binding:2,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}]}),o=e.createBindGroupLayout({label:"FFT Wave Realized Fourier Amplitude h(k,t) Group 1",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]});this.realizedAmplitudeKernel=e.createComputePipeline({label:"FFT Wave Realized Fourier Amplitude h(k,t)",layout:e.createPipelineLayout({label:"FFT Wave Realized Fourier Amplitude h(k,t)",bindGroupLayouts:[s,o]}),compute:{module:n,entryPoint:"computeRealizedAmplitude"}});const l=e.createBindGroupLayout({label:"FFT Wave Accumulate Turbulence Group 0",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,storageTexture:{viewDimension:"2d-array",format:te}},{binding:1,visibility:GPUShaderStage.COMPUTE,texture:{viewDimension:"2d-array",sampleType:"unfilterable-float"}},{binding:2,visibility:GPUShaderStage.COMPUTE,texture:{viewDimension:"2d-array",sampleType:"unfilterable-float"}},{binding:3,visibility:GPUShaderStage.COMPUTE,texture:{viewDimension:"2d-array",sampleType:"unfilterable-float"}},{binding:4,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]});this.accumulateTurbulenceKernel=e.createComputePipeline({label:"FFT Wave Accumulate Turbulence",layout:e.createPipelineLayout({label:"FFT Wave Accumulate Turbulence",bindGroupLayouts:[l]}),compute:{module:n,entryPoint:"accumulateTurbulence"}});function u(d){const h=2*d;return 2*Math.PI/h}const _=[200,50,10],p=[.001,..._.map(d=>u(d/this.gridSize)),1e3],y=_.map((d,h)=>({patchExtentMeters:d,waveNumberMinMax:[p[h],p[h+1]]}));this.cascadeCount=y.length,this.dfftResources=new je(e,O,this.cascadeCount),this.Dx_Dy_Dz_Dxdz_SpatialArray=e.createTexture({label:"FFT Wave Final Displacement Array",format:$e,dimension:"2d",size:this.textureGridSize,mipLevelCount:O,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC|GPUTextureUsage.COPY_DST}),this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray=e.createTexture({label:"FFT Wave Final Derivatives Array",format:this.Dx_Dy_Dz_Dxdz_SpatialArray.format,size:this.textureGridSize,mipLevelCount:this.Dx_Dy_Dz_Dxdz_SpatialArray.mipLevelCount,usage:this.Dx_Dy_Dz_Dxdz_SpatialArray.usage}),this.cascades=this.createCascades(e,t,y);const g=15360,m=this.textureGridSize.width*this.textureGridSize.height*this.textureGridSize.depthOrArrayLayers,b=new Uint16Array(m*4).fill(g);this.turbulenceJacobianArrays=[0,0].map((d,h)=>e.createTexture({label:`FFT Wave (Turbulence,Jacobian) Array ${h}`,format:te,size:this.textureGridSize,mipLevelCount:O,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC|GPUTextureUsage.COPY_DST})).reduce((d,h,S,f)=>{e.queue.writeTexture({texture:h},b,{bytesPerRow:this.Dx_Dy_Dz_Dxdz_SpatialArray.width*8,rowsPerImage:this.Dx_Dy_Dz_Dxdz_SpatialArray.height},this.textureGridSize);const A=e.createBindGroup({layout:this.accumulateTurbulenceKernel.getBindGroupLayout(0),entries:[{binding:0,resource:h.createView({mipLevelCount:1})},{binding:1,resource:f[(S+1)%f.length].createView({})},{binding:2,resource:this.Dx_Dy_Dz_Dxdz_SpatialArray.createView({})},{binding:3,resource:this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray.createView({})},{binding:4,resource:{buffer:t.buffer}}]});return d.concat({textureArray:h,bindGroup:A,mipMapBindings:this.mipMapGenerator.createBindGroups(e,h)})},[]),this.Dx_Dy_Dz_Dxdz_SpatialArray_MipMapBindings=this.mipMapGenerator.createBindGroups(e,this.Dx_Dy_Dz_Dxdz_SpatialArray),this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray_MipMapBindings=this.mipMapGenerator.createBindGroups(e,this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray),this.waveSettings={gravity:0,waveSwell:0,windFetchMeters:0,windSpeedMetersPerSeconds:0}}get textureGridSize(){return{width:this.gridSize,height:this.gridSize,depthOrArrayLayers:this.cascadeCount}}get turbulenceMapIndex(){return this.turbulenceJacobianIndex}createCascades(e,t,a){const i=this.textureGridSize,n=i.width*i.height*i.depthOrArrayLayers,s=e.createTexture({label:"FFT Wave Gaussian Noise",format:Ze,size:i,usage:GPUTextureUsage.COPY_DST|GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING}),o=2,l=8,u=new Float32Array(n*o);for(let S=0;S<u.length;S++)u[S]=tt()[0];e.queue.writeTexture({texture:s},u,{bytesPerRow:l*i.width,rowsPerImage:i.height},i);const _=new et(e);a.forEach((S,f)=>{_.data.cascades[f]={wave_number_min_max:T.create(...S.waveNumberMinMax),wave_patch_extent_meters:S.patchExtentMeters,padding0:0}}),_.writeToGPU(e.queue);const p=e.createTexture({label:"FFT Wave Fourier Amplitude h_0(k)",format:ee,size:i,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING}),y=e.createBindGroup({label:"FFT Wave Initial Amplitude h_0(k) Group 0",layout:this.initialAmplitudeKernel.getBindGroupLayout(0),entries:[{binding:0,resource:p.createView()},{binding:1,resource:s.createView()}]}),g=e.createBindGroup({label:"FFT Wave Initial Amplitude h_0(k) Group 1",layout:this.initialAmplitudeKernel.getBindGroupLayout(1),entries:[{binding:0,resource:{buffer:t.buffer}},{binding:1,resource:{buffer:_.buffer}}]}),m=e.createTexture({label:"FFT Wave Packed (Dx + iDy, Dz + iDxdz) Amplitude",format:G,size:i,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),b=e.createTexture({label:"FFT Wave Packed (Dydx + iDydz, Dxdx + iDzdz) Amplitude",format:m.format,size:i,usage:m.usage}),d=e.createBindGroup({label:"FFT Wave Realized Fourier Amplitude h(k,t) Group 0",layout:this.realizedAmplitudeKernel.getBindGroupLayout(0),entries:[{binding:0,resource:m.createView()},{binding:1,resource:b.createView()},{binding:2,resource:p.createView()}]}),h=e.createBindGroup({label:"FFT Wave Realized Fourier Amplitude h(k,t) Group 1",layout:this.realizedAmplitudeKernel.getBindGroupLayout(1),entries:[{binding:0,resource:{buffer:t.buffer}},{binding:1,resource:{buffer:_.buffer}}]});return{gaussianNoiseArray:s,initialAmplitudeArray:p,waveSettings:_,initialAmplitudeGroup0:y,initialAmplitudeGroup1:g,packed_Dx_plus_iDy_Dz_iDxdz_AmplitudeArray:m,packed_Dydx_plus_iDydz_Dxdx_plus_iDzdz_AmplitudeArray:b,realizedAmplitudeGroup0:d,realizedAmplitudeGroup1:h}}views(){return{gaussianNoise:new x(this.cascades.gaussianNoiseArray),initialAmplitude:new x(this.cascades.initialAmplitudeArray),packed_Dx_plus_iDy_Dz_iDxdz_Amplitude:new x(this.cascades.packed_Dx_plus_iDy_Dz_iDxdz_AmplitudeArray),packed_Dydx_plus_iDydz_Dxdx_plus_iDzdz_Amplitude:new x(this.cascades.packed_Dydx_plus_iDydz_Dxdx_plus_iDzdz_AmplitudeArray),turbulenceJacobian:new x(this.turbulenceJacobianArrays[0].textureArray),Dx_Dy_Dz_Dxdz_Spatial:new x(this.Dx_Dy_Dz_Dxdz_SpatialArray),Dydx_Dydz_Dxdx_Dzdz_Spatial:new x(this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray)}}displacementMaps(){return new at(this.Dx_Dy_Dz_Dxdz_SpatialArray,this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray,this.turbulenceJacobianArrays.map(e=>e.textureArray))}record(e,t,a,i){if(a.gravity!=this.waveSettings.gravity||a.waveSwell!=this.waveSettings.waveSwell||a.windSpeedMetersPerSeconds!=this.waveSettings.windSpeedMetersPerSeconds||a.windFetchMeters!=this.waveSettings.windFetchMeters){this.waveSettings=structuredClone(a);const l=t.beginComputePass({label:"FFT Wave Initial Amplitude"}),u=this.cascades.waveSettings;u.data.wave_swell=this.waveSettings.waveSwell,u.data.wind_fetch_meters=this.waveSettings.windFetchMeters,u.data.wind_speed_meters_per_second=this.waveSettings.windSpeedMetersPerSeconds,u.data.gravity=this.waveSettings.gravity,u.writeToGPU(e.queue),l.setPipeline(this.initialAmplitudeKernel),l.setBindGroup(0,this.cascades.initialAmplitudeGroup0),l.setBindGroup(1,this.cascades.initialAmplitudeGroup1);const _=this.textureGridSize;l.dispatchWorkgroups(_.width/16,_.height/16,_.depthOrArrayLayers/1),l.end()}{const l=t.beginComputePass({label:"FFT Wave Fourier Amplitude Realization",timestampWrites:i!==void 0?{querySet:i.querySet,beginningOfPassWriteIndex:i.beginWriteIndex}:void 0});l.setPipeline(this.realizedAmplitudeKernel),l.setBindGroup(0,this.cascades.realizedAmplitudeGroup0),l.setBindGroup(1,this.cascades.realizedAmplitudeGroup1);const u=this.textureGridSize;l.dispatchWorkgroups(u.width/16,u.height/16,u.depthOrArrayLayers/1),l.end()}this.dfftResources.recordPerform(e,t,this.cascades.packed_Dx_plus_iDy_Dz_iDxdz_AmplitudeArray,this.Dx_Dy_Dz_Dxdz_SpatialArray,!0,void 0),this.dfftResources.recordPerform(e,t,this.cascades.packed_Dydx_plus_iDydz_Dxdx_plus_iDzdz_AmplitudeArray,this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray,!0,void 0);const s=t.beginComputePass({label:"Turbulence Accumulation"});s.setPipeline(this.accumulateTurbulenceKernel),s.setBindGroup(0,this.turbulenceJacobianArrays[this.turbulenceJacobianIndex].bindGroup),s.dispatchWorkgroups(this.gridSize/16,this.gridSize/16),s.end();const o=t.beginComputePass({label:"MipMap Generation",timestampWrites:i!==void 0?{querySet:i.querySet,endOfPassWriteIndex:i.endWriteIndex}:void 0});this.mipMapGenerator.recordUpdateMipMaps(o,this.Dx_Dy_Dz_Dxdz_SpatialArray_MipMapBindings),this.mipMapGenerator.recordUpdateMipMaps(o,this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray_MipMapBindings),this.mipMapGenerator.recordUpdateMipMaps(o,this.turbulenceJacobianArrays[this.turbulenceJacobianIndex].mipMapBindings),this.turbulenceJacobianIndex+=1,this.turbulenceJacobianIndex%=this.turbulenceJacobianArrays.length,o.end()}}const it=`// Displace a grid of vertices representing the ocean surface, then rasterize into the gbuffer with a graphics pass
...
`,re=4;class nt extends P{constructor(t){const a=12+4*re;super(t,a,"Wave Surface Displacement Patch World Half Extent UBO");r(this,"data",{patch_world_half_extent:50,b_gerstner:!0,b_displacement_map:!0,vertex_size:1e3,gbuffer_extent:T.create(1,1),foam_scale:1,foam_bias:0,padding0:w.create(0,0,0),procedural_wave_count:12,cascades:[{patch_size_meters:200},{patch_size_meters:50},{patch_size_meters:10},{patch_size_meters:0}]})}packed(){const t=new ArrayBuffer(this.buffer.size),a=new DataView(t),i=new Float32Array(t);a.setFloat32(0,this.data.patch_world_half_extent,!0),a.setUint32(4,this.data.b_gerstner?1:0,!0),a.setUint32(8,this.data.b_displacement_map?1:0,!0),a.setUint32(12,this.data.vertex_size,!0),i.set(this.data.gbuffer_extent,4),a.setFloat32(24,this.data.foam_scale,!0),a.setFloat32(28,this.data.foam_bias,!0),i.set(this.data.padding0,8),a.setUint32(44,this.data.procedural_wave_count,!0);const n=w.create(0,0,0);for(let s=0;s<re;s++){const o=12+s*4;i.set(n,o),a.setFloat32((o+3)*4,this.data.cascades[s].patch_size_meters,!0)}return t}}class st{constructor(e,t,a,i,n,s){r(this,"oceanSurfaceRasterizationPipeline");r(this,"group0");r(this,"group1");r(this,"group2ByTurbulenceMapIndex");r(this,"settingsUBO");r(this,"baseIndexCount");r(this,"indices");this.baseIndexCount=6279174,this.indices=e.createBuffer({size:6279174*4,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.INDEX,label:"Wave Surface Displacement Indices"});const p=new Uint32Array(6279174);let y=0;for(let z=0;z<1023;z++)for(let D=0;D<1023;D++){const E=D+z*1024,W=E+1,L=E+1024,ue=L+1,V=new Uint32Array([E,L,W,W,L,ue]);p.set(V,y),y+=V.length}e.queue.writeBuffer(this.indices,0,p);const g=12,m=4,b=4*m,d=e.createBuffer({size:g*b,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.STORAGE,label:"Wave Surface Displacement Waves"}),h=9.8,S=60,f=S*S*h/(2*Math.PI),A=new Array({direction:T.create(.4,2),amplitude:.25,wavelength:f/(12*12)},{direction:T.create(.6,2),amplitude:.3,wavelength:f/(14*14)},{direction:T.create(.8,2),amplitude:.35,wavelength:f/(12*12)},{direction:T.create(1,2),amplitude:.4,wavelength:f/(16*16)},{direction:T.create(1.2,2),amplitude:.45,wavelength:f/(12*12)},{direction:T.create(1.4,2),amplitude:.4,wavelength:f/(14*14)},{direction:T.create(1.6,2),amplitude:.35,wavelength:f/(12*12)},{direction:T.create(1.8,2),amplitude:.3,wavelength:f/(16*16)},{direction:T.create(.8,1.5),amplitude:.02,wavelength:f/(30*30)},{direction:T.create(1.1,1.5),amplitude:.02,wavelength:f/(30*30)},{direction:T.create(1.2,1.5),amplitude:.02,wavelength:f/(30*30)},{direction:T.create(1.3,1.5),amplitude:.02,wavelength:f/(30*30)}),U=new Float32Array(g*m);let R=0;A.forEach(z=>{U.set(z.direction,R),U[R+2]=z.amplitude,U[R+3]=z.wavelength,R+=4}),e.queue.writeBuffer(d,0,U),this.settingsUBO=new nt(e),this.settingsUBO.data.vertex_size=1024,this.settingsUBO.data.procedural_wave_count=A.length;const B=e.createBindGroupLayout({label:"Wave Surface Displacement Group 1 Compute (Displacement Map)",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array"}},{binding:3,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}}]});this.group1=e.createBindGroup({label:"Wave Surface Displacement Group 1 Compute (Displacement Map)",layout:B,entries:[{binding:0,resource:e.createSampler({label:"Wave Surface Displacement Group 1 Sampler",minFilter:"linear",magFilter:"linear",mipmapFilter:"linear",addressModeU:"repeat",addressModeV:"repeat",maxAnisotropy:10})},{binding:1,resource:s.Dx_Dy_Dz_Dxdz_SpatialAllMips},{binding:2,resource:s.Dydx_Dydz_Dxdx_Dzdz_SpatialAllMips},{binding:3,resource:{buffer:d}}]});const k=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array"}}]});this.group2ByTurbulenceMapIndex=s.turbulenceJacobianOneMip.map((z,D)=>e.createBindGroup({label:`Wave Surface Displacement Group 2 Compute (Turbulence) index ${D}`,layout:k,entries:[{binding:0,resource:z}]}));const q=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}],label:"Wave Surface Displacement Group 0"});this.group0=e.createBindGroup({layout:q,entries:[{binding:0,resource:{buffer:this.settingsUBO.buffer}},{binding:1,resource:{buffer:t.buffer}}],label:"Wave Surface Displacement Group 0"});const N=e.createShaderModule({code:it,label:"Wave Surface Displacement"});this.oceanSurfaceRasterizationPipeline=e.createRenderPipeline({layout:e.createPipelineLayout({bindGroupLayouts:[q,B,k]}),vertex:{module:N,entryPoint:"screenSpaceWarped"},fragment:{module:N,entryPoint:"rasterizationFragment",targets:[{format:a},{format:i}]},primitive:{topology:"triangle-list",cullMode:"back",frontFace:"cw"},depthStencil:{format:n,depthWriteEnabled:!0,depthCompare:"less"},label:"Wave Surface Displacement Surface Rasterization"})}record(e,t,a,i,n,s){this.settingsUBO.data.patch_world_half_extent=n.fft?100:300,this.settingsUBO.data.b_gerstner=n.gerstner,this.settingsUBO.data.b_displacement_map=n.fft,this.settingsUBO.data.foam_bias=n.foamBias,this.settingsUBO.data.gbuffer_extent=s.extent,this.settingsUBO.data.foam_scale=n.foamScale,this.settingsUBO.writeToGPU(e.queue);const o=t.beginRenderPass({label:"Wave Surface Rasterization",colorAttachments:[{clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store",view:s.colorWithSurfaceWorldDepthInAlpha},{clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store",view:s.normalWithSurfaceFoamInAlpha}],depthStencilAttachment:{view:s.depth,depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"store"},timestampWrites:a!==void 0?{querySet:a.querySet,beginningOfPassWriteIndex:a.beginWriteIndex,endOfPassWriteIndex:a.endWriteIndex}:void 0});o.setPipeline(this.oceanSurfaceRasterizationPipeline),o.setBindGroup(0,this.group0),o.setBindGroup(1,this.group1),o.setBindGroup(2,this.group2ByTurbulenceMapIndex[i]),o.setIndexBuffer(this.indices,"uint32"),o.drawIndexed(this.baseIndexCount,1),o.end()}}const ot=`// Call this in a render pass, passing in an index buffer [0, 1, 2, 0, 2, 3]
...
`;class lt{constructor(){r(this,"color_gain",M.create(1,1,1,1));r(this,"vertex_scale",M.create(1,1,1,1));r(this,"swap_ba_rg",!1);r(this,"channel_mask",7);r(this,"depth_or_array_layer",0);r(this,"mip_level_u32",0)}}class ut extends P{constructor(t){super(t,12,"Fullscreen Quad UBO");r(this,"data",new lt)}packed(){const t=new ArrayBuffer(this.buffer.size),a=new DataView(t);return new Float32Array(t).set(this.data.color_gain,0/4),new Float32Array(t).set(this.data.vertex_scale,16/4),a.setUint32(32,this.data.swap_ba_rg?1:0,!0),a.setUint32(36,this.data.channel_mask,!0),a.setFloat32(40,this.data.depth_or_array_layer,!0),a.setUint32(44,this.data.mip_level_u32,!0),t}}class ct{constructor(e,t){r(this,"group0Layout");r(this,"group0LayoutArray");r(this,"group0Layout3D");r(this,"group0ByOutputTexture");r(this,"group0Sampler");r(this,"ubo");r(this,"fullscreenQuadIndexBuffer");r(this,"group1");r(this,"pipeline");r(this,"pipelineArray");r(this,"pipeline3D");r(this,"outputFormat");this.outputFormat=t;const a=new Uint32Array([0,1,2,0,2,3]);this.fullscreenQuadIndexBuffer=e.createBuffer({size:a.byteLength,usage:GPUBufferUsage.INDEX|GPUBufferUsage.COPY_DST}),e.queue.writeBuffer(this.fullscreenQuadIndexBuffer,0,a,0,a.length),this.group0Layout=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"non-filtering"}}],label:"Fullscreen Quad Group 0"}),this.group0LayoutArray=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{viewDimension:"2d-array",sampleType:"unfilterable-float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"non-filtering"}}],label:"Fullscreen Quad Group 0 Array"}),this.group0Layout3D=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{viewDimension:"3d",sampleType:"unfilterable-float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"non-filtering"}}],label:"Fullscreen Quad Group 0 3D"}),this.group0ByOutputTexture=new Map,this.group0Sampler=e.createSampler({magFilter:"nearest",minFilter:"nearest"}),this.ubo=new ut(e);const i=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}}],label:"Fullscreen Quad Group 1"});this.group1=e.createBindGroup({layout:i,entries:[{binding:0,resource:{buffer:this.ubo.buffer}}]});const n=e.createShaderModule({code:ot,label:"Fullscreen Quad"});this.pipeline=e.createRenderPipeline({vertex:{module:n,entryPoint:"vertexMain"},fragment:{module:n,entryPoint:"fragmentMain",targets:[{format:t}]},primitive:{topology:"triangle-list",cullMode:"none",frontFace:"ccw"},layout:e.createPipelineLayout({bindGroupLayouts:[this.group0Layout,i]}),label:"Fullscreen Quad 2D"}),this.pipelineArray=e.createRenderPipeline({vertex:{module:n,entryPoint:"vertexMain"},fragment:{module:n,entryPoint:"fragmentMainArray",targets:[{format:t}]},primitive:{topology:"triangle-list",cullMode:"none",frontFace:"ccw"},layout:e.createPipelineLayout({bindGroupLayouts:[this.group0LayoutArray,i]}),label:"Fullscreen Quad 2D Array"}),this.pipeline3D=e.createRenderPipeline({vertex:{module:n,entryPoint:"vertexMain"},fragment:{module:n,entryPoint:"fragmentMain3D",targets:[{format:t}]},primitive:{topology:"triangle-list",cullMode:"none",frontFace:"ccw"},layout:e.createPipelineLayout({bindGroupLayouts:[this.group0Layout3D,i]}),label:"Fullscreen Quad 3D"})}setOutput(e,t,a){let i=this.group0Layout;switch(a.viewDimension){case"2d":{i=this.group0Layout;break}case"2d-array":{i=this.group0LayoutArray;break}case"3d":{i=this.group0Layout3D;break}default:throw new RangeError(`Unsupported texture dimension '${a.viewDimension}'`)}this.group0ByOutputTexture.set(t,{texture:a,bindGroup:e.createBindGroup({layout:i,entries:[{binding:0,resource:a.view},{binding:1,resource:this.group0Sampler}],label:`Fullscreen Quad Group 0 Texture '${a.view.label}'`})})}getAllTextureProperties(){return[...this.group0ByOutputTexture.entries()].map(([e,{texture:t}])=>({category:e,mipLevelCount:t.mipLevelCount,depthOrArrayLayerCount:t.depthOrArrayLayerCount}))}record(e,t,a,i,n,s){const o={r:0,g:0,b:0,a:1},l=this.group0ByOutputTexture.get(i);if(l===void 0){console.warn("FullscreenQuadPass: No texture to output.");return}const u=t.beginRenderPass({colorAttachments:[{clearValue:o,loadOp:"clear",storeOp:"store",view:a}],timestampWrites:s!==void 0?{querySet:s.querySet,beginningOfPassWriteIndex:s.beginWriteIndex,endOfPassWriteIndex:s.endWriteIndex}:void 0,label:"Fullscreen Pass"});switch(this.ubo.data.color_gain=M.create(n.colorGain.r,n.colorGain.g,n.colorGain.b,1),this.ubo.data.vertex_scale=M.create(1,n.flip?-1:1,1,1),this.ubo.data.mip_level_u32=Math.round(n.mipLevel),this.ubo.data.depth_or_array_layer=n.arrayLayer,this.ubo.data.channel_mask=(n.channelMasks.r?1:0)+(n.channelMasks.g?2:0)+(n.channelMasks.b?4:0),this.ubo.data.swap_ba_rg=n.swapBARG,this.ubo.writeToGPU(e.queue),u.setIndexBuffer(this.fullscreenQuadIndexBuffer,"uint32",0,this.fullscreenQuadIndexBuffer.size),u.setBindGroup(1,this.group1),l.texture.viewDimension){case"2d":{u.setPipeline(this.pipeline);break}case"2d-array":{u.setPipeline(this.pipelineArray);break}case"3d":{u.setPipeline(this.pipeline3D);break}default:throw new Error(`Unsupported texture dimension '${l.texture.viewDimension}'`)}u.setBindGroup(0,l.bindGroup),u.drawIndexed(6,1,0,0,0),u.end()}}const F=["SkyviewLUT","AerialPerspectiveLUT","FFTWaves","OceanSurface","AtmosphereCamera","FullscreenQuad"],ie=["DrawToDraw",...F];class ne{constructor(e){r(this,"values");r(this,"sum",0);r(this,"average_",0);r(this,"count",0);r(this,"index",0);this.values=new Array(e).fill(0)}get average(){return this.average_}push(e){this.index>=this.values.length&&(this.index=0),this.index<this.count&&(this.sum-=this.values[this.index]),this.values[this.index]=e,this.sum+=e,this.count=Math.min(this.values.length,this.count+1),this.average_=this.sum/this.count,this.index+=1}}class dt{constructor(e){r(this,"queryBuffers");r(this,"frametimeAverages");r(this,"timestampIndexMapping",new Map);r(this,"timestampQueryIndex",0);r(this,"uiDisplay");if(this.frametimeAverages=new Map([["DrawToDraw",new ne(400)]]),this.uiDisplay={averageFPS:0,frametimeControllers:new Map},!e.features.has("timestamp-query")){console.warn("WebGPU feature 'timestamp-query' is not supported. Continuing, but without performance information about specific stages.");return}const a=8,i=2*F.length;this.queryBuffers={mappingLock:!1,querySet:e.createQuerySet({type:"timestamp",count:i}),writeBuffer:e.createBuffer({size:a*i,usage:GPUBufferUsage.COPY_SRC|GPUBufferUsage.QUERY_RESOLVE}),readBuffer:e.createBuffer({size:a*i,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ})},F.forEach(n=>{this.frametimeAverages.set(n,new ne(400))})}setupUI(e){const t=e.addFolder("Performance").close();t.add(this.uiDisplay,"averageFPS").decimals(1).disable().name("Average FPS").listen(),ie.forEach(a=>{this.uiDisplay.frametimeControllers.set(a,t.add({value:0},"value").name(`${a} (ms)`).decimals(6).disable())})}startFrame(e){var t;(t=this.frametimeAverages.get("DrawToDraw"))==null||t.push(e),this.timestampQueryIndex=0,this.timestampIndexMapping.clear()}pushTimestampQueryInterval(e){if(this.queryBuffers===void 0)return;this.timestampIndexMapping.set(e,this.timestampQueryIndex);const t=this.timestampQueryIndex,a=t+1;return this.timestampQueryIndex+=2,{querySet:this.queryBuffers.querySet,beginWriteIndex:t,endWriteIndex:a}}recordCopyBuffers(e){this.queryBuffers==null||this.queryBuffers.readBuffer.mapState!=="unmapped"||(e.resolveQuerySet(this.queryBuffers.querySet,0,this.timestampQueryIndex,this.queryBuffers.writeBuffer,0),e.copyBufferToBuffer(this.queryBuffers.writeBuffer,0,this.queryBuffers.readBuffer,0,this.queryBuffers.readBuffer.size))}asyncUpdateFrametimeAverages(){if(this.queryBuffers==null||this.queryBuffers.readBuffer.mapState!=="unmapped")return;const e=this.queryBuffers.readBuffer;e.mapAsync(GPUMapMode.READ,0,e.size).then(()=>{var a;const t=new BigInt64Array(e.getMappedRange(0,e.size));this.timestampIndexMapping.forEach((i,n)=>{var l;const o=Number(t.at(i+1)-t.at(i))/1e6;(l=this.frametimeAverages.get(n))==null||l.push(o)}),this.uiDisplay.averageFPS=1e3/(((a=this.frametimeAverages.get("DrawToDraw"))==null?void 0:a.average)??1e3),ie.forEach(i=>{var s,o;const n=(s=this.frametimeAverages.get(i))==null?void 0:s.average;n!==void 0&&((o=this.uiDisplay.frametimeControllers.get(i))==null||o.setValue(n))}),e.unmap()}).catch(t=>{console.error("Failed while retrieving frametime values from GPU:"),console.error(t)})}}const _t={width:2048,height:1024},mt={width:1024,height:1024},pt={width:1024,height:512},ht={width:32,height:32,depthOrArrayLayers:32},le=[.25,.3333,.5,.75,1,1.5,2,4];function ft(c,e,t){c.add(e,"renderScale",le).name("Render Resolution Scale").decimals(1).onFinishChange(u=>{t()}).listen();const a=c.addFolder("Camera").open();a.add(e.oceanCamera,"translationX").name("Camera X").min(-100).max(100),a.add(e.oceanCamera,"translationY").name("Camera Y").min(10).max(2e3),a.add(e.oceanCamera,"translationZ").name("Camera Z").min(-100).max(100);const i=.01;a.add(e.oceanCamera,"eulerAnglesX").name("Camera Pitch").min(-Math.PI/2+i).max(Math.PI/2-i),a.add(e.oceanCamera,"eulerAnglesY").name("Camera Yaw").min(-Math.PI).max(Math.PI);const n=c.addFolder("Sun").open();n.add(e.orbit,"timeHours").min(0).max(24).name("Time in Hours").listen(),n.add(e.orbit,"timeSpeedupFactor").min(1).max(5e4).step(1).name("Time Multiplier"),n.add(e.orbit,"paused").name("Pause Sun"),n.add({fn:()=>{e.orbit.timeHours=e.orbit.reversed?18+.5:6-.5}},"fn").name("Skip to Sunrise"),n.add({fn:()=>{e.orbit.timeHours=e.orbit.reversed?6+.5:18-.5}},"fn").name("Skip to Sunset"),n.add(e.orbit,"reversed").name("Reverse Sun"),n.add(e.orbit,"sunsetAzimuthRadians").name("Sun Azimuth").min(0).max(2*Math.PI),n.add(e.orbit,"inclinationRadians").name("Sun Inclination").min(0).max(Math.PI);const s=c.addFolder("Ocean").close();s.add(e.oceanSurfaceSettings,"gerstner").name("Gerstner Waves"),s.add(e.oceanSurfaceSettings,"fft").name("FFT Accelerated Waves"),s.add(e.time,"pause").name("Pause Waves"),s.add(e.oceanSurfaceSettings,"foamScale").name("Foam Scale").min(-30).max(30),s.add(e.oceanSurfaceSettings,"foamBias").name("Foam Bias").min(-1).max(1),s.add(e.fourierWavesSettings,"gravity").name("Gravity (m / s^2)").min(.01).max(20),s.add(e.fourierWavesSettings,"waveSwell").name("Wave Swell").min(.01).max(1),s.add(e.fourierWavesSettings,"windFetchMeters").name("Wind Fetch (m)").min(10*1e3).max(100*1e3),s.add(e.fourierWavesSettings,"windSpeedMetersPerSeconds").name("Wind Speed (m/s)").min(.01).max(50);const o=c.addFolder("Debug").close(),l=[];o.add(e,"renderFromOceanPOV").name("Render from Ocean POV").onFinishChange(u=>{l.forEach(_=>{_.enable(!u)})}),l.push(o.add(e.debugCamera,"translationX").name("Camera X").min(-100).max(100),o.add(e.debugCamera,"translationY").name("Camera Y").min(10).max(1e3),o.add(e.debugCamera,"translationZ").name("Camera Z").min(-100).max(100),o.add(e.debugCamera,"eulerAnglesX").name("Camera Pitch").min(-Math.PI/2+i).max(Math.PI/2-i),o.add(e.debugCamera,"eulerAnglesY").name("Camera Yaw").min(-Math.PI).max(Math.PI),o.add({fn:()=>{Object.assign(e.debugCamera,structuredClone(e.oceanCamera)),o.controllers.forEach(u=>{u.updateDisplay()})}},"fn").name("Reset to match main camera")),l.forEach(u=>u.enable(!1))}class gt{constructor(e,t){r(this,"transmittanceLUTPassResources");r(this,"multiscatterLUTPassResources");r(this,"skyviewLUTPassResources");r(this,"aerialPerspectiveLUTPassResources");r(this,"fftWaveSpectrumResources");r(this,"waveSurfaceDisplacementPassResources");r(this,"atmosphereCameraPassResources");r(this,"fullscreenQuadPassResources");r(this,"gbuffer");r(this,"unscaledResolution");r(this,"renderOutputController");r(this,"parameters");r(this,"performance");r(this,"globalUBO");r(this,"device");r(this,"quit",!1);r(this,"dummyFrameCounter");r(this,"float32Filterable");this.device=e,this.float32Filterable=e.features.has("float32-filterable"),this.renderOutputController=new Be,this.parameters={oceanSurfaceSettings:{gerstner:!0,fft:!0,foamScale:15,foamBias:.25},renderFromOceanPOV:!0,oceanCamera:{translationX:0,translationY:20,translationZ:0,eulerAnglesX:-.2,eulerAnglesY:0,eulerAnglesZ:0},debugCamera:{translationX:0,translationY:40,translationZ:-20,eulerAnglesX:-.4,eulerAnglesY:0,eulerAnglesZ:0},fourierWavesSettings:{gravity:9.8,windSpeedMetersPerSeconds:15,windFetchMeters:40*1e3,waveSwell:.3},time:{pause:!1,timeSeconds:0,deltaTimeSeconds:0},orbit:{timeHours:5.7,timeSpeedupFactor:400,paused:!1,reversed:!1,inclinationRadians:Math.PI/2,sunsetAzimuthRadians:Math.PI},renderScale:1},this.unscaledResolution={width:1,height:1},this.performance=new dt(this.device),this.dummyFrameCounter=10,this.globalUBO=new Se(this.device),this.globalUBO.writeToGPU(this.device.queue),this.gbuffer=new $(e,{width:1,height:1}),this.transmittanceLUTPassResources=new Ae(this.device,_t,this.globalUBO),this.multiscatterLUTPassResources=new Pe(this.device,mt,this.transmittanceLUTPassResources.view,this.float32Filterable,this.globalUBO),this.skyviewLUTPassResources=new Re(this.device,pt,this.transmittanceLUTPassResources.view,this.multiscatterLUTPassResources.view,this.float32Filterable,this.globalUBO),this.aerialPerspectiveLUTPassResources=new Ie(this.device,ht,this.transmittanceLUTPassResources.view,this.multiscatterLUTPassResources.view,this.float32Filterable,this.globalUBO),this.fftWaveSpectrumResources=new rt(this.device,this.globalUBO);const a=this.fftWaveSpectrumResources.views();this.waveSurfaceDisplacementPassResources=new st(this.device,this.globalUBO,this.gbuffer.colorWithSurfaceWorldDepthInAlpha.format,this.gbuffer.normalWithSurfaceFoamStrengthInAlpha.format,this.gbuffer.depth.format,this.fftWaveSpectrumResources.displacementMaps()),this.atmosphereCameraPassResources=new Le(this.device,this.gbuffer.readGroupLayout,this.transmittanceLUTPassResources.view,this.multiscatterLUTPassResources.view,this.skyviewLUTPassResources.view,this.aerialPerspectiveLUTPassResources.view,this.float32Filterable,this.globalUBO),this.fullscreenQuadPassResources=new ct(this.device,t),[["Scene",new x(this.atmosphereCameraPassResources.outputColor)],["GBufferColor",new x(this.gbuffer.colorWithSurfaceWorldDepthInAlpha)],["GBufferNormal",new x(this.gbuffer.normalWithSurfaceFoamStrengthInAlpha)],["AtmosphereTransmittanceLUT",new x(this.transmittanceLUTPassResources.texture)],["AtmosphereMultiscatterLUT",new x(this.multiscatterLUTPassResources.texture)],["AtmosphereSkyviewLUT",new x(this.skyviewLUTPassResources.texture)],["AtmosphereAerialPerspectiveLUT",new x(this.aerialPerspectiveLUTPassResources.texture)],["FFTWaveSpectrumGaussianNoise",a.gaussianNoise],["FFTWaveInitialAmplitude",a.initialAmplitude],["FFTWaveDx_plus_iDy_Dz_iDxdz_Amplitude",a.packed_Dx_plus_iDy_Dz_iDxdz_Amplitude],["FFTWaveDydx_plus_iDydz_Dxdx_plus_iDzdz_Amplitude",a.packed_Dydx_plus_iDydz_Dxdx_plus_iDzdz_Amplitude],["FFTWaveTurbulenceJacobian",a.turbulenceJacobian],["FFTWaveDx_Dy_Dz_Dxdz_Spatial",a.Dx_Dy_Dz_Dxdz_Spatial],["FFTWaveDydx_Dydz_Dxdx_Dzdz_Spatial",a.Dydx_Dydz_Dxdx_Dzdz_Spatial]].forEach(([n,s])=>{this.fullscreenQuadPassResources.setOutput(this.device,n,s)});for(const n of this.fullscreenQuadPassResources.getAllTextureProperties())this.renderOutputController.setTextureProperties(n);const i=e.createCommandEncoder({label:"Atmosphere LUT Initialization"});this.transmittanceLUTPassResources.record(i),this.multiscatterLUTPassResources.record(i),e.queue.submit([i.finish()])}presentationInterface(){return{device:this.device,format:this.fullscreenQuadPassResources.outputFormat}}setupUI(e){ft(e,this.parameters,()=>{this.updateResizableResources()}),this.renderOutputController.setupUI(e),this.performance.setupUI(e)}tickTime(e){const i=this.parameters.oceanSurfaceSettings.fft?100:60,n=this.parameters.time;n.pause?n.deltaTimeSeconds=0:(n.deltaTimeSeconds=e/1e3,n.timeSeconds+=n.deltaTimeSeconds),n.timeSeconds-=Math.floor(n.timeSeconds/i)*i;const s=this.parameters.orbit;s.paused||(s.timeHours+=(s.reversed?-1:1)*s.timeSpeedupFactor*e/36e5,s.timeHours=s.timeHours-Math.floor(s.timeHours/24)*24)}updateGlobalUBO(e){const t=this.parameters;this.globalUBO.data.time.deltaTimeSeconds=t.time.deltaTimeSeconds,this.globalUBO.data.time.timeSeconds=t.time.timeSeconds;const a=2*Math.PI/24,i=(12-t.orbit.timeHours)*a,n=w.create(-Math.sin(t.orbit.sunsetAzimuthRadians),0,Math.cos(t.orbit.sunsetAzimuthRadians)),s=w.create(Math.cos(t.orbit.sunsetAzimuthRadians)*Math.cos(t.orbit.inclinationRadians),Math.sin(t.orbit.inclinationRadians),Math.sin(t.orbit.sunsetAzimuthRadians)*Math.cos(t.orbit.inclinationRadians)),o=w.add(w.scale(n,Math.sin(i)),w.scale(s,Math.cos(i)));w.scale(o,-1,this.globalUBO.data.light.forward);const l=60*Math.PI/180,p=v.perspective(l,e,.1,1e3),y=(g,m)=>{const b=[m.translationX,m.translationY,m.translationZ,1],d=v.rotationX(m.eulerAnglesX),h=v.rotationY(m.eulerAnglesY),S=v.rotationZ(m.eulerAnglesZ),f=v.mul(v.translation(M.create(...b)),v.mul(h,v.mul(d,S))),A=v.inverse(f);Object.assign(g,{invProj:v.inverse(p),invView:f,projView:v.mul(p,A),position:M.create(...b),forward:M.create(...v.multiply(f,M.create(0,0,-1,0)))})};y(this.globalUBO.data.ocean_camera,t.oceanCamera),y(this.globalUBO.data.camera,t.renderFromOceanPOV?t.oceanCamera:t.debugCamera),this.globalUBO.writeToGPU(this.device.queue)}draw(e,t,a,i){if(this.dummyFrameCounter>0){this.dummyFrameCounter-=1;return}const n=e.createView();this.performance.startFrame(i),this.tickTime(i),this.updateGlobalUBO(t);const s=this.device.createCommandEncoder({label:"Main"});this.fftWaveSpectrumResources.record(this.device,s,this.parameters.fourierWavesSettings,this.performance.pushTimestampQueryInterval("FFTWaves")),this.waveSurfaceDisplacementPassResources.record(this.device,s,this.performance.pushTimestampQueryInterval("OceanSurface"),this.fftWaveSpectrumResources.turbulenceMapIndex,{gerstner:this.parameters.oceanSurfaceSettings.gerstner,fft:this.parameters.oceanSurfaceSettings.fft,foamBias:this.parameters.oceanSurfaceSettings.foamBias,foamScale:this.parameters.oceanSurfaceSettings.foamScale},{extent:T.create(this.gbuffer.colorWithSurfaceWorldDepthInAlpha.width,this.gbuffer.colorWithSurfaceWorldDepthInAlpha.height),colorWithSurfaceWorldDepthInAlpha:this.gbuffer.colorWithSurfaceWorldDepthInAlphaView,normalWithSurfaceFoamInAlpha:this.gbuffer.normalWithSurfaceFoamStrengthInAlphaView,depth:this.gbuffer.depthView}),this.skyviewLUTPassResources.record(s,this.performance.pushTimestampQueryInterval("SkyviewLUT")),this.aerialPerspectiveLUTPassResources.record(s,this.performance.pushTimestampQueryInterval("AerialPerspectiveLUT")),this.atmosphereCameraPassResources.record(s,this.performance.pushTimestampQueryInterval("AtmosphereCamera"),this.gbuffer);const o=this.renderOutputController.current();this.fullscreenQuadPassResources.record(this.device,s,n,o.category,o.transform,this.performance.pushTimestampQueryInterval("FullscreenQuad")),this.performance.recordCopyBuffers(s),this.device.queue.submit([s.finish()]),this.performance.asyncUpdateFrametimeAverages()}updateResizableResources(){const e=s=>({width:Math.floor(this.unscaledResolution.width*s),height:Math.floor(this.unscaledResolution.height*s)}),t=s=>s.width<8192&&s.height<8192&&s.width*s.height*16<268435456;let a=this.parameters.renderScale;const i=e(a);t(i)||(le.slice().reverse().some(s=>{if(t(e(s)))return a=s,!0}),console.warn(`During resize: Texture size (${i.width},${i.height}) exceeds WebGPU guaranteed limit (8192, 8192).
					Defaulting to highest possible render scale of ${a}`)),this.parameters.renderScale=a;const n=e(this.parameters.renderScale);console.log(`Resizing to (${n.width},${n.height})`),this.gbuffer=new $(this.device,n,this.gbuffer),this.fullscreenQuadPassResources.setOutput(this.device,"GBufferColor",new x(this.gbuffer.colorWithSurfaceWorldDepthInAlpha)),this.fullscreenQuadPassResources.setOutput(this.device,"GBufferNormal",new x(this.gbuffer.normalWithSurfaceFoamStrengthInAlpha)),this.atmosphereCameraPassResources.resize(n,this.device,this.transmittanceLUTPassResources.view,this.multiscatterLUTPassResources.view,this.skyviewLUTPassResources.view,this.aerialPerspectiveLUTPassResources.view),this.fullscreenQuadPassResources.setOutput(this.device,"Scene",new x(this.atmosphereCameraPassResources.outputColor));for(const s of this.fullscreenQuadPassResources.getAllTextureProperties())this.renderOutputController.setTextureProperties(s)}handleResize(e,t){this.unscaledResolution.width=e,this.unscaledResolution.height=t,this.updateResizableResources()}}const bt=(c,e)=>new gt(c,e);export{bt as SkySeaAppConstructor};
