var oe=Object.defineProperty;var le=(l,e,t)=>e in l?oe(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t;var r=(l,e,t)=>le(l,typeof e!="symbol"?e+"":e,t);import{m as b,v as M,a as w,b as T}from"./wgpu-matrix.module-BO3i1RYM.js";const ue=4;class R{constructor(e,t,a){r(this,"buffer");this.buffer=e.createBuffer({size:t*ue,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.UNIFORM,label:a})}writeToGPU(e){const t=this.packed();t.byteLength!=this.buffer.size&&console.warn(`GPUBuffer label: '${this.buffer.label}' uploaded with improper size. Expected: ${this.buffer.size} bytes, got ${t.byteLength} bytes.`),e.writeBuffer(this.buffer,0,t)}}function ce(){return{rayleighMm:{scattering:w.create(5.802,13.558,33.1),absorption:w.create(0,0,0),densityScale:.008},mieMm:{scattering:w.create(3.996,3.996,3.996),absorption:w.create(4.4,4.4,4.4),densityScale:.0012},ozoneMm:{scattering:w.create(0,0,0),absorption:w.create(.65,1.881,.085)},planetRadiusMm:6.36,atmosphereRadiusMm:6.42,groundAlbedo:w.create(.3*1,.3*.75,.3*.4)}}function de(){return{color:w.create(1,1,1),strength:60,forward:w.create(0,-1,0),angularRadius:16/60*(3.141592653589793/180)}}const _e=16,me=128,pe=16,he=32,fe=16,W=256,ge=16,ve=16;function ye(l,e){return Math.ceil(e/l)*l}const be=Math.max(_e,pe,fe,ge),xe=ye(be,W+W+me+he+ve);class we extends R{constructor(t){super(t,xe/4,"Global UBO");r(this,"data",{atmosphere:ce(),light:de(),camera:{invProj:b.identity(),invView:b.identity(),projView:b.identity(),position:M.create(0,0,0,1),forward:M.create(0,0,-1,0)},ocean_camera:{invProj:b.identity(),invView:b.identity(),projView:b.identity(),position:M.create(0,0,0,1),forward:M.create(0,0,-1,0)},time:{timeSeconds:0,deltaTimeSeconds:0}})}packed(){const t=new Float32Array(2).fill(0),a=new Float32Array(4).fill(0),i=new Float32Array(4*2).fill(0),n=this.data.atmosphere,o=n.rayleighMm,s=n.mieMm,u=new Float32Array([...o.scattering,o.densityScale,...o.absorption,n.planetRadiusMm,...s.scattering,s.densityScale,...s.absorption,n.atmosphereRadiusMm,...n.groundAlbedo,0,...n.ozoneMm.scattering,0,...n.ozoneMm.absorption,0,...a]),c=this.data.light,_=new Float32Array([...c.color,c.strength,...c.forward,c.angularRadius]),d=this.data.camera,v=new Float32Array([...d.invProj,...d.invView,...d.projView,...d.position,...d.forward,...i]),f=this.data.ocean_camera,y=new Float32Array([...f.invProj,...f.invView,...f.projView,...f.position,...f.forward,...i]),m=this.data.time,g=new Float32Array([...t,m.timeSeconds,m.deltaTimeSeconds]);return new Float32Array([...v,...y,...u,..._,...g])}}const Te=`// Sizeof(Atmosphere) = 8 * 16 = 128
...
`;class We extends R{constructor(t){super(t,3,"DFFT Parameters UBO");r(this,"data",{log_2_size:1,size:2,b_inverse:!1})}packed(){const t=new ArrayBuffer(this.buffer.size),a=new DataView(t);return a.setUint32(0,this.data.log_2_size,!0),a.setUint32(4,this.data.size,!0),a.setFloat32(8,this.data.b_inverse?1:0,!0),t}}const K=16,C="rgba16float";class Ve{constructor(e,t,a){r(this,"parametersUBO");r(this,"butterfliesBuffer");r(this,"gridSize3D");r(this,"complexBuffer0");r(this,"complexBuffer1");r(this,"stepCounterBuffer");r(this,"outputTexture");r(this,"butterfliesBindGroup");r(this,"computeButterfliesKernel");r(this,"performBindGroup");r(this,"performKernel");r(this,"performSwapEvenSignsAndCopyToHalfPrecisionOutputKernel");r(this,"stepCounterBindGroup");r(this,"incrementStepCounterKernel");r(this,"resetStepCounterKernel");if(t<5)throw new RangeError("gridSizeExponent must be greater than 4.");if(!Number.isFinite(a)||a<1)throw new RangeError(`layerCount of ${a} is invalid`);const i=Math.pow(2,t);this.gridSize3D={width:i,height:i,depthOrArrayLayers:a};const n=this.gridSize3D.width*this.gridSize3D.height*this.gridSize3D.depthOrArrayLayers;this.parametersUBO=new We(e),this.parametersUBO.data.log_2_size=t,this.parametersUBO.data.size=i,this.parametersUBO.data.b_inverse=!1,this.parametersUBO.writeToGPU(e.queue);const o=16;this.butterfliesBuffer=e.createBuffer({label:"DFFT Precompute Stage Steps",size:t*i*o,usage:GPUBufferUsage.STORAGE});const s=e.createShaderModule({label:"DFFT Precompute Stage",code:Ne}),u=e.createBindGroupLayout({label:"DFFT Precompute Stage Group 0",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]});this.butterfliesBindGroup=e.createBindGroup({label:"DFFT Precompute Stage Group 0",layout:u,entries:[{binding:0,resource:{buffer:this.parametersUBO.buffer}},{binding:1,resource:{buffer:this.butterfliesBuffer}}]});const c=e.createPipelineLayout({label:"DFFT Precompute Steps Kernel",bindGroupLayouts:[u]});this.computeButterfliesKernel=e.createComputePipeline({label:"DFFT Precompute Stage",compute:{module:s,entryPoint:"precomputeDFFTInstructions"},layout:c});const _=e.createBindGroupLayout({label:"DFFT Perform Group 0",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:4,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:5,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:6,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:C,viewDimension:"2d-array",access:"write-only"}}]});this.complexBuffer0=e.createBuffer({label:"DFFT Buffer 0",size:n*K,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),this.complexBuffer1=e.createBuffer({label:"DFFT Buffer 1",size:this.complexBuffer0.size,usage:this.complexBuffer0.usage});const d=4;this.stepCounterBuffer=e.createBuffer({label:"DFFT Step Counter",size:d,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.STORAGE|GPUBufferUsage.UNIFORM});const v=new Uint32Array(1);v[0]=0,e.queue.writeBuffer(this.stepCounterBuffer,0,v),this.outputTexture=e.createTexture({label:"DFFT Output Texture",format:C,size:this.gridSize3D,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.COPY_SRC}),this.performBindGroup=e.createBindGroup({label:"DFFT Perform Group 0",layout:_,entries:[{binding:0,resource:{buffer:this.parametersUBO.buffer}},{binding:2,resource:{buffer:this.butterfliesBuffer}},{binding:3,resource:{buffer:this.complexBuffer0}},{binding:4,resource:{buffer:this.complexBuffer1}},{binding:5,resource:{buffer:this.stepCounterBuffer}},{binding:6,resource:this.outputTexture.createView()}]});const f=e.createPipelineLayout({label:"DFFT Perform",bindGroupLayouts:[_]});this.performKernel=e.createComputePipeline({label:"DFFT Perform DFFT Step",compute:{module:s,entryPoint:"performDFFTStep"},layout:f}),this.performSwapEvenSignsAndCopyToHalfPrecisionOutputKernel=e.createComputePipeline({label:"DFFT Perform Swap Even Signs",compute:{module:s,entryPoint:"performSwapEvenSignsAndCopyToHalfPrecisionOutput"},layout:f});const y=e.createBindGroupLayout({label:"DFFT Step Counter Bind Group 0",entries:[{binding:7,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]});this.stepCounterBindGroup=e.createBindGroup({label:"DFFT Step Counter Bind Group 0",layout:y,entries:[{binding:7,resource:{buffer:this.stepCounterBuffer}}]});const m=e.createPipelineLayout({label:"DFFT Step Counter",bindGroupLayouts:[y]});this.incrementStepCounterKernel=e.createComputePipeline({label:"DFFT Increment Step Counter Kernel",layout:m,compute:{module:s,entryPoint:"incrementStepCounter"}}),this.resetStepCounterKernel=e.createComputePipeline({label:"DFFT Reset Step Counter Kernel",layout:m,compute:{module:s,entryPoint:"resetStepCounter"}}),this.parametersUBO.data.b_inverse=!0,this.parametersUBO.writeToGPU(e.queue);const g=e.createCommandEncoder({label:"DFFT Precompute"}),p=g.beginComputePass({label:"DFFT Precompute Steps"});p.setPipeline(this.computeButterfliesKernel),p.setBindGroup(0,this.butterfliesBindGroup),p.dispatchWorkgroups(i/2/2,1),p.end(),e.queue.submit([g.finish()])}recordPerformOnBuffer0(e,t){const a=2*this.parametersUBO.data.log_2_size,i=e.beginComputePass({label:"DFFT Perform",timestampWrites:t});for(let n=0;n<a;n++)n===0?(i.setPipeline(this.resetStepCounterKernel),i.setBindGroup(0,this.stepCounterBindGroup),i.dispatchWorkgroups(1)):(i.setPipeline(this.incrementStepCounterKernel),i.setBindGroup(0,this.stepCounterBindGroup),i.dispatchWorkgroups(1)),i.setPipeline(this.performKernel),i.setBindGroup(0,this.performBindGroup),i.dispatchWorkgroups(this.gridSize3D.width/16,this.gridSize3D.height/16,this.gridSize3D.depthOrArrayLayers/1);i.setPipeline(this.performSwapEvenSignsAndCopyToHalfPrecisionOutputKernel),i.setBindGroup(0,this.performBindGroup),i.dispatchWorkgroups(this.gridSize3D.width/16,this.gridSize3D.height/16,this.gridSize3D.depthOrArrayLayers/1),i.end()}recordPerform(e,t,a,i,n,o){const s="rgba32float";if(a.format!=s)throw RangeError(`sourceTexture (format ${a.format}) must be ${s}`);if(i.format!=C)throw RangeError(`destinationArray (format ${a.format}) must be ${s}`);if(a.width!=i.width||a.height!=i.height||a.depthOrArrayLayers!=i.depthOrArrayLayers)throw RangeError(`SourceTexture ${a.label} does not match destination texture ${i.label} extent`);this.parametersUBO.data.b_inverse=n,this.parametersUBO.writeToGPU(e.queue),t.copyTextureToBuffer({texture:a},{buffer:this.complexBuffer0,bytesPerRow:this.gridSize3D.width*K,rowsPerImage:this.gridSize3D.height},this.gridSize3D),this.recordPerformOnBuffer0(t,o),t.copyTextureToTexture({texture:this.outputTexture},{texture:i},this.gridSize3D)}}const He=`@group(0) @binding(0) var out_next_mip_level: texture_storage_2d_array<rgba16float, write>;
...
`,G="rgba16float";class je{constructor(e){r(this,"fillMipMapTextureInOutLayout");r(this,"fillMipMapKernel");r(this,"fillMipMapSmallerKernel");this.fillMipMapTextureInOutLayout=e.createBindGroupLayout({label:"MipMap Generation fillMipMap Texture In-Out",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:G,viewDimension:"2d-array"}},{binding:1,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}]});const t=e.createShaderModule({label:"sky-sea/mipmap.wgsl",code:He}),a=e.createPipelineLayout({label:"MipMap Generation fillMipMap Kernel",bindGroupLayouts:[this.fillMipMapTextureInOutLayout]});this.fillMipMapKernel=e.createComputePipeline({label:"MipMap Generation fillMipMap Kernel",layout:a,compute:{module:t,entryPoint:"fillMipMap"}}),this.fillMipMapSmallerKernel=e.createComputePipeline({label:"MipMap Generation fillMipMapSmaller Kernel",layout:a,compute:{module:t,entryPoint:"fillMipMapSmaller"}})}createBindGroups(e,t){if(t.format!=G)throw new RangeError(`Invalid source texture (label ${t.label}) for MipMap generation`,{cause:`Source format is ${t.format} when expected ${G}`});if(t.dimension!="2d")throw new RangeError(`Invalid source texture (label ${t.label}) for MipMap generation`,{cause:"Source texture is not 2d"});if(!(t.usage&GPUTextureUsage.COPY_SRC))throw new RangeError(`Invalid source texture (label ${t.label}) for MipMap generation`,{cause:"Source usage is missing required flag COPY_SRC"});if(t.width!=t.height||!Number.isInteger(Math.log2(t.width)))throw new RangeError(`Invalid source texture (label ${t.label}) for MipMap generation`,{cause:`Source dimensions of (${t.width},${t.height}) are invalid, texture must be square and power-of-2.`});const a=Math.log2(t.width);return{level0Size:{width:t.width,height:t.height},bindGroupsByMipLevel:[...new Array(Math.min(a,t.mipLevelCount)-1).keys()].map((i,n)=>{const o=n+1,s=n;return e.createBindGroup({label:`MipMap Generation for '${t.label}' IO Bind Group '${s} => ${o}'`,layout:this.fillMipMapTextureInOutLayout,entries:[{binding:0,resource:t.createView({dimension:"2d-array",baseMipLevel:o,mipLevelCount:1})},{binding:1,resource:t.createView({dimension:"2d-array",baseMipLevel:s,mipLevelCount:1})}]})}),arrayLevelCount:t.depthOrArrayLayers}}recordUpdateMipMaps(e,t){t.bindGroupsByMipLevel.forEach((a,i)=>{e.setBindGroup(0,a);const n=1<<i,o=t.level0Size.width/n,s=t.level0Size.height/n;o>=16&&s>=16?(e.setPipeline(this.fillMipMapKernel),e.dispatchWorkgroups(o/16,s/16,t.arrayLevelCount)):(e.setPipeline(this.fillMipMapSmallerKernel),e.dispatchWorkgroups(o,s,t.arrayLevelCount))})}}const Ye=9.8,Xe=100,Qe="rg32float",Z="rg32float",Ke="rgba16float",J="rgba16float",I="rgba32float",Ze=4,$=4;class Je extends R{constructor(t){super(t,8+Ze*$,"Fourier Waves UBO");r(this,"data",{fourier_grid_size:1,gravity:Ye,padding0:0,wave_period_seconds:Xe,wind_speed_meters_per_second:10,wind_fetch_meters:10*1e3,wave_swell:.3,padding1:0,cascades:new Array(4)})}packed(){const t=new ArrayBuffer(this.buffer.size),a=new DataView(t),i=new Float32Array(t);a.setUint32(0,this.data.fourier_grid_size,!0),a.setFloat32(4,this.data.gravity,!0),a.setFloat32(8,this.data.padding0,!0),a.setFloat32(12,this.data.wave_period_seconds,!0),a.setFloat32(16,this.data.wind_speed_meters_per_second,!0),a.setFloat32(20,this.data.wind_fetch_meters,!0),a.setFloat32(24,this.data.wave_swell,!0),a.setFloat32(28,this.data.padding1,!0);const n=8;return this.data.cascades.forEach((o,s)=>{const u=n+s*$;i.set(o.wave_number_min_max,u),i[u+2]=o.wave_patch_extent_meters,i[u+3]=0}),t}}function $e(){const l=Math.random(),e=Math.random(),t=Math.sqrt(-2*Math.log(l)),a=2*Math.PI*e,i=t*Math.cos(a),n=t*Math.sin(a);return[i,n]}class et{constructor(e,t,a){r(this,"Dx_Dy_Dz_Dxdz_Spatial");r(this,"Dydx_Dydz_Dxdx_Dzdz_Spatial");r(this,"turbulenceJacobian");r(this,"Dx_Dy_Dz_Dxdz_SpatialAllMips");r(this,"Dydx_Dydz_Dxdx_Dzdz_SpatialAllMips");r(this,"turbulenceJacobianOneMip");e.mipLevelCount!=t.mipLevelCount&&console.warn(`FFT Wave Displacement maps do not have identical mip levels. ${e.mipLevelCount} vs ${t.mipLevelCount}`),this.Dx_Dy_Dz_Dxdz_Spatial=e,this.Dydx_Dydz_Dxdx_Dzdz_Spatial=t,this.turbulenceJacobian=a,this.Dx_Dy_Dz_Dxdz_SpatialAllMips=this.Dx_Dy_Dz_Dxdz_Spatial.createView({label:`FFT Wave DisplacementMaps for ${this.Dx_Dy_Dz_Dxdz_Spatial.label}`}),this.Dydx_Dydz_Dxdx_Dzdz_SpatialAllMips=this.Dydx_Dydz_Dxdx_Dzdz_Spatial.createView({label:`FFT Wave DisplacementMaps for ${this.Dydx_Dydz_Dxdx_Dzdz_Spatial.label}`}),this.turbulenceJacobianOneMip=this.turbulenceJacobian.map((i,n)=>i.createView({label:`FFT Wave DisplacementMaps for ${this.turbulenceJacobian[n].label} index ${n}`}))}get mipLevelCount(){return this.Dx_Dy_Dz_Dxdz_Spatial.mipLevelCount}}class tt{constructor(e,t,a){r(this,"gridSize");r(this,"cascadeCount");r(this,"initialAmplitudeKernel");r(this,"realizedAmplitudeKernel");r(this,"accumulateTurbulenceKernel");r(this,"dfftResources");r(this,"mipMapGenerator");r(this,"cascades");r(this,"Dx_Dy_Dz_Dxdz_SpatialArray");r(this,"Dydx_Dydz_Dxdx_Dzdz_SpatialArray");r(this,"turbulenceJacobianArrays");r(this,"turbulenceJacobianGroup1");r(this,"turbulenceJacobianIndex",0);r(this,"Dx_Dy_Dz_Dxdz_SpatialArray_MipMapBindings");r(this,"Dydx_Dydz_Dxdx_Dzdz_SpatialArray_MipMapBindings");r(this,"waveSettings");this.gridSize=Math.pow(2,a);const i=e.createBindGroupLayout({label:"FFT Wave Initial Amplitude h_0(k) Group 0",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:Z,viewDimension:"2d-array",access:"write-only"}},{binding:1,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}]}),n=e.createBindGroupLayout({label:"FFT Wave Initial Amplitude h_0(k) Group 1",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),o=e.createShaderModule({label:"FFT Wave",code:qe});this.initialAmplitudeKernel=e.createComputePipeline({label:"FFT Wave Initial Amplitude h_0(k)",layout:e.createPipelineLayout({label:"FFT Wave Initial Amplitude h_0(k)",bindGroupLayouts:[i,n]}),compute:{module:o,entryPoint:"computeInitialAmplitude"}}),this.mipMapGenerator=new je(e);const s=e.createBindGroupLayout({label:"FFT Wave Realized Fourier Amplitude h(k,t) Group 0",entries:[{binding:2,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:I,viewDimension:"2d-array",access:"write-only"}},{binding:3,visibility:GPUShaderStage.COMPUTE,storageTexture:{format:I,viewDimension:"2d-array",access:"write-only"}},{binding:4,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}]}),u=e.createBindGroupLayout({label:"FFT Wave Realized Fourier Amplitude h(k,t) Group 1",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]});this.realizedAmplitudeKernel=e.createComputePipeline({label:"FFT Wave Realized Fourier Amplitude h(k,t)",layout:e.createPipelineLayout({label:"FFT Wave Realized Fourier Amplitude h(k,t)",bindGroupLayouts:[s,u]}),compute:{module:o,entryPoint:"computeRealizedAmplitude"}});const c=e.createBindGroupLayout({label:"FFT Wave Accumulate Turbulence Group 0",entries:[{binding:5,visibility:GPUShaderStage.COMPUTE,storageTexture:{viewDimension:"2d-array",format:J}},{binding:6,visibility:GPUShaderStage.COMPUTE,texture:{viewDimension:"2d-array",sampleType:"unfilterable-float"}},{binding:7,visibility:GPUShaderStage.COMPUTE,texture:{viewDimension:"2d-array",sampleType:"unfilterable-float"}},{binding:8,visibility:GPUShaderStage.COMPUTE,texture:{viewDimension:"2d-array",sampleType:"unfilterable-float"}}]}),_=e.createBindGroupLayout({label:"FFT Wave Accumulate Turbulence Group 1",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]});this.accumulateTurbulenceKernel=e.createComputePipeline({label:"FFT Wave Accumulate Turbulence",layout:e.createPipelineLayout({label:"FFT Wave Accumulate Turbulence",bindGroupLayouts:[c,_]}),compute:{module:o,entryPoint:"accumulateTurbulence"}});function d(x){const h=2*x;return 2*Math.PI/h}const v=[200,50,10],f=[.001,...v.map(x=>d(x/this.gridSize)),1e3],y=v.map((x,h)=>({patchExtentMeters:x,waveNumberMinMax:[f[h],f[h+1]]}));this.cascadeCount=y.length,this.dfftResources=new Ve(e,a,this.cascadeCount),this.Dx_Dy_Dz_Dxdz_SpatialArray=e.createTexture({label:"FFT Wave Final Displacement Array",format:Ke,dimension:"2d",size:this.textureGridSize,mipLevelCount:a,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC|GPUTextureUsage.COPY_DST}),this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray=e.createTexture({label:"FFT Wave Final Derivatives Array",format:this.Dx_Dy_Dz_Dxdz_SpatialArray.format,size:this.textureGridSize,mipLevelCount:this.Dx_Dy_Dz_Dxdz_SpatialArray.mipLevelCount,usage:this.Dx_Dy_Dz_Dxdz_SpatialArray.usage}),this.cascades=this.createCascades(e,t,this.gridSize,y);const m=15360,g=this.textureGridSize.width*this.textureGridSize.height*this.textureGridSize.depthOrArrayLayers,p=new Uint16Array(g*4).fill(m);this.turbulenceJacobianArrays=[0,0].map((x,h)=>e.createTexture({label:`FFT Wave (Turbulence,Jacobian) Array ${h}`,format:J,size:this.textureGridSize,mipLevelCount:a,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC|GPUTextureUsage.COPY_DST})).reduce((x,h,z,D)=>{e.queue.writeTexture({texture:h},p,{bytesPerRow:this.Dx_Dy_Dz_Dxdz_SpatialArray.width*8,rowsPerImage:this.Dx_Dy_Dz_Dxdz_SpatialArray.height},this.textureGridSize);const U=e.createBindGroup({layout:this.accumulateTurbulenceKernel.getBindGroupLayout(0),entries:[{binding:5,resource:h.createView({mipLevelCount:1})},{binding:6,resource:D[(z+1)%D.length].createView({})},{binding:7,resource:this.Dx_Dy_Dz_Dxdz_SpatialArray.createView({})},{binding:8,resource:this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray.createView({})}]});return x.concat({textureArray:h,bindGroup:U,mipMapBindings:this.mipMapGenerator.createBindGroups(e,h)})},[]),this.turbulenceJacobianGroup1=e.createBindGroup({label:"FFT Wave Accumulate Turbulence Group 1",layout:this.accumulateTurbulenceKernel.getBindGroupLayout(1),entries:[{binding:0,resource:{buffer:t.buffer}}]}),this.Dx_Dy_Dz_Dxdz_SpatialArray_MipMapBindings=this.mipMapGenerator.createBindGroups(e,this.Dx_Dy_Dz_Dxdz_SpatialArray),this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray_MipMapBindings=this.mipMapGenerator.createBindGroups(e,this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray),this.waveSettings={gravity:0,waveSwell:0,windFetchMeters:0,windSpeedMetersPerSeconds:0}}get textureGridSize(){return{width:this.gridSize,height:this.gridSize,depthOrArrayLayers:this.cascadeCount}}get turbulenceMapIndex(){return this.turbulenceJacobianIndex}createCascades(e,t,a,i){const n=this.textureGridSize,o=n.width*n.height*n.depthOrArrayLayers,s=e.createTexture({label:"FFT Wave Gaussian Noise",format:Qe,size:n,usage:GPUTextureUsage.COPY_DST|GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING}),u=2,c=8,_=new Float32Array(o*u);for(let h=0;h<_.length;h++)_[h]=$e()[0];e.queue.writeTexture({texture:s},_,{bytesPerRow:c*n.width,rowsPerImage:n.height},n);const d=new Je(e);d.data.fourier_grid_size=a,i.forEach((h,z)=>{d.data.cascades[z]={wave_number_min_max:T.create(...h.waveNumberMinMax),wave_patch_extent_meters:h.patchExtentMeters,padding0:0}}),d.writeToGPU(e.queue);const v=e.createTexture({label:"FFT Wave Fourier Amplitude h_0(k)",format:Z,size:n,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING}),f=e.createBindGroup({label:"FFT Wave Initial Amplitude h_0(k) Group 0",layout:this.initialAmplitudeKernel.getBindGroupLayout(0),entries:[{binding:0,resource:v.createView()},{binding:1,resource:s.createView()}]}),y=e.createBindGroup({label:"FFT Wave Initial Amplitude h_0(k) Group 1",layout:this.initialAmplitudeKernel.getBindGroupLayout(1),entries:[{binding:0,resource:{buffer:t.buffer}},{binding:1,resource:{buffer:d.buffer}}]}),m=e.createTexture({label:"FFT Wave Packed (Dx + iDy, Dz + iDxdz) Amplitude",format:I,size:n,usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),g=e.createTexture({label:"FFT Wave Packed (Dydx + iDydz, Dxdx + iDzdz) Amplitude",format:m.format,size:n,usage:m.usage}),p=e.createBindGroup({label:"FFT Wave Realized Fourier Amplitude h(k,t) Group 0",layout:this.realizedAmplitudeKernel.getBindGroupLayout(0),entries:[{binding:2,resource:m.createView()},{binding:3,resource:g.createView()},{binding:4,resource:v.createView()}]}),x=e.createBindGroup({label:"FFT Wave Realized Fourier Amplitude h(k,t) Group 1",layout:this.realizedAmplitudeKernel.getBindGroupLayout(1),entries:[{binding:0,resource:{buffer:t.buffer}},{binding:1,resource:{buffer:d.buffer}}]});return{gaussianNoiseArray:s,initialAmplitudeArray:v,waveSettings:d,initialAmplitudeGroup0:f,initialAmplitudeGroup1:y,packed_Dx_plus_iDy_Dz_iDxdz_AmplitudeArray:m,packed_Dydx_plus_iDydz_Dxdx_plus_iDzdz_AmplitudeArray:g,realizedAmplitudeGroup0:p,realizedAmplitudeGroup1:x}}views(){return{gaussianNoise:new S(this.cascades.gaussianNoiseArray),initialAmplitude:new S(this.cascades.initialAmplitudeArray),packed_Dx_plus_iDy_Dz_iDxdz_Amplitude:new S(this.cascades.packed_Dx_plus_iDy_Dz_iDxdz_AmplitudeArray),packed_Dydx_plus_iDydz_Dxdx_plus_iDzdz_Amplitude:new S(this.cascades.packed_Dydx_plus_iDydz_Dxdx_plus_iDzdz_AmplitudeArray),turbulenceJacobian:new S(this.turbulenceJacobianArrays[0].textureArray),Dx_Dy_Dz_Dxdz_Spatial:new S(this.Dx_Dy_Dz_Dxdz_SpatialArray),Dydx_Dydz_Dxdx_Dzdz_Spatial:new S(this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray)}}displacementMaps(){return new et(this.Dx_Dy_Dz_Dxdz_SpatialArray,this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray,this.turbulenceJacobianArrays.map(e=>e.textureArray))}record(e,t,a,i){if(a.gravity!=this.waveSettings.gravity||a.waveSwell!=this.waveSettings.waveSwell||a.windSpeedMetersPerSeconds!=this.waveSettings.windSpeedMetersPerSeconds||a.windFetchMeters!=this.waveSettings.windFetchMeters){this.waveSettings=structuredClone(a);const u=t.beginComputePass({label:"FFT Wave Initial Amplitude"}),c=this.cascades.waveSettings;c.data.wave_swell=this.waveSettings.waveSwell,c.data.wind_fetch_meters=this.waveSettings.windFetchMeters,c.data.wind_speed_meters_per_second=this.waveSettings.windSpeedMetersPerSeconds,c.data.gravity=this.waveSettings.gravity,c.writeToGPU(e.queue),u.setPipeline(this.initialAmplitudeKernel),u.setBindGroup(0,this.cascades.initialAmplitudeGroup0),u.setBindGroup(1,this.cascades.initialAmplitudeGroup1);const _=this.textureGridSize;u.dispatchWorkgroups(_.width/16,_.height/16,_.depthOrArrayLayers/1),u.end()}{const u=t.beginComputePass({label:"FFT Wave Fourier Amplitude Realization",timestampWrites:i!==void 0?{querySet:i.querySet,beginningOfPassWriteIndex:i.beginWriteIndex}:void 0});u.setPipeline(this.realizedAmplitudeKernel),u.setBindGroup(0,this.cascades.realizedAmplitudeGroup0),u.setBindGroup(1,this.cascades.realizedAmplitudeGroup1);const c=this.textureGridSize;u.dispatchWorkgroups(c.width/16,c.height/16,c.depthOrArrayLayers/1),u.end()}this.dfftResources.recordPerform(e,t,this.cascades.packed_Dx_plus_iDy_Dz_iDxdz_AmplitudeArray,this.Dx_Dy_Dz_Dxdz_SpatialArray,!0,void 0),this.dfftResources.recordPerform(e,t,this.cascades.packed_Dydx_plus_iDydz_Dxdx_plus_iDzdz_AmplitudeArray,this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray,!0,void 0);const o=t.beginComputePass({label:"Turbulence Accumulation"});o.setPipeline(this.accumulateTurbulenceKernel),o.setBindGroup(0,this.turbulenceJacobianArrays[this.turbulenceJacobianIndex].bindGroup),o.setBindGroup(1,this.turbulenceJacobianGroup1),o.dispatchWorkgroups(this.gridSize/16,this.gridSize/16,this.cascadeCount/1),o.end();const s=t.beginComputePass({label:"MipMap Generation",timestampWrites:i!==void 0?{querySet:i.querySet,endOfPassWriteIndex:i.endWriteIndex}:void 0});this.mipMapGenerator.recordUpdateMipMaps(s,this.Dx_Dy_Dz_Dxdz_SpatialArray_MipMapBindings),this.mipMapGenerator.recordUpdateMipMaps(s,this.Dydx_Dydz_Dxdx_Dzdz_SpatialArray_MipMapBindings),this.mipMapGenerator.recordUpdateMipMaps(s,this.turbulenceJacobianArrays[this.turbulenceJacobianIndex].mipMapBindings),this.turbulenceJacobianIndex+=1,this.turbulenceJacobianIndex%=this.turbulenceJacobianArrays.length,s.end()}}const at=`// Displace a grid of vertices representing the ocean surface, then rasterize into the gbuffer with a graphics pass
...
`,ee=4;class rt extends R{constructor(t){const a=12+4*ee;super(t,a,"Wave Surface Displacement Patch World Half Extent UBO");r(this,"data",{patch_world_half_extent:50,b_gerstner:!0,b_displacement_map:!0,vertex_size:1e3,gbuffer_extent:T.create(1,1),foam_scale:1,foam_bias:0,padding0:w.create(0,0,0),procedural_wave_count:12,cascades:[{patch_size_meters:200},{patch_size_meters:50},{patch_size_meters:10},{patch_size_meters:0}]})}packed(){const t=new ArrayBuffer(this.buffer.size),a=new DataView(t),i=new Float32Array(t);a.setFloat32(0,this.data.patch_world_half_extent,!0),a.setUint32(4,this.data.b_gerstner?1:0,!0),a.setUint32(8,this.data.b_displacement_map?1:0,!0),a.setUint32(12,this.data.vertex_size,!0),i.set(this.data.gbuffer_extent,4),a.setFloat32(24,this.data.foam_scale,!0),a.setFloat32(28,this.data.foam_bias,!0),i.set(this.data.padding0,8),a.setUint32(44,this.data.procedural_wave_count,!0);const n=w.create(0,0,0);for(let o=0;o<ee;o++){const s=12+o*4;i.set(n,s),a.setFloat32((s+3)*4,this.data.cascades[o].patch_size_meters,!0)}return t}}class it{constructor(e,t,a,i){r(this,"oceanSurfaceRasterizationPipeline");r(this,"group0");r(this,"group1");r(this,"group2ByTurbulenceMapIndex");r(this,"settingsUBO");r(this,"baseIndexCount");r(this,"indices");this.baseIndexCount=6279174,this.indices=e.createBuffer({size:6279174*4,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.INDEX,label:"Wave Surface Displacement Indices"});const c=new Uint32Array(6279174);let _=0;for(let A=0;A<1023;A++)for(let P=0;P<1023;P++){const E=P+A*1024,q=E+1,L=E+1024,se=L+1,N=new Uint32Array([E,L,q,q,L,se]);c.set(N,_),_+=N.length}e.queue.writeBuffer(this.indices,0,c);const d=12,v=4,f=4*v,y=e.createBuffer({size:d*f,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.STORAGE,label:"Wave Surface Displacement Waves"}),m=9.8,g=60,p=g*g*m/(2*Math.PI),x=new Array({direction:T.create(.4,2),amplitude:.25,wavelength:p/(12*12)},{direction:T.create(.6,2),amplitude:.3,wavelength:p/(14*14)},{direction:T.create(.8,2),amplitude:.35,wavelength:p/(12*12)},{direction:T.create(1,2),amplitude:.4,wavelength:p/(16*16)},{direction:T.create(1.2,2),amplitude:.45,wavelength:p/(12*12)},{direction:T.create(1.4,2),amplitude:.4,wavelength:p/(14*14)},{direction:T.create(1.6,2),amplitude:.35,wavelength:p/(12*12)},{direction:T.create(1.8,2),amplitude:.3,wavelength:p/(16*16)},{direction:T.create(.8,1.5),amplitude:.02,wavelength:p/(30*30)},{direction:T.create(1.1,1.5),amplitude:.02,wavelength:p/(30*30)},{direction:T.create(1.2,1.5),amplitude:.02,wavelength:p/(30*30)},{direction:T.create(1.3,1.5),amplitude:.02,wavelength:p/(30*30)}),h=new Float32Array(d*v);let z=0;x.forEach(A=>{h.set(A.direction,z),h[z+2]=A.amplitude,h[z+3]=A.wavelength,z+=4}),e.queue.writeBuffer(y,0,h),this.settingsUBO=new rt(e),this.settingsUBO.data.vertex_size=1024,this.settingsUBO.data.procedural_wave_count=x.length;const D=e.createBindGroupLayout({label:"Wave Surface Displacement Group 1 Compute (Displacement Map)",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array"}},{binding:3,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}}]});this.group1=e.createBindGroup({label:"Wave Surface Displacement Group 1 Compute (Displacement Map)",layout:D,entries:[{binding:0,resource:e.createSampler({label:"Wave Surface Displacement Group 1 Sampler",minFilter:"linear",magFilter:"linear",mipmapFilter:"linear",addressModeU:"repeat",addressModeV:"repeat",maxAnisotropy:10})},{binding:1,resource:i.Dx_Dy_Dz_Dxdz_SpatialAllMips},{binding:2,resource:i.Dydx_Dydz_Dxdx_Dzdz_SpatialAllMips},{binding:3,resource:{buffer:y}}]});const U=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array"}}]});this.group2ByTurbulenceMapIndex=i.turbulenceJacobianOneMip.map((A,P)=>e.createBindGroup({label:`Wave Surface Displacement Group 2 Compute (Turbulence) index ${P}`,layout:U,entries:[{binding:0,resource:A}]}));const B=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}],label:"Wave Surface Displacement Group 0"});this.group0=e.createBindGroup({layout:B,entries:[{binding:0,resource:{buffer:this.settingsUBO.buffer}},{binding:1,resource:{buffer:t.buffer}}],label:"Wave Surface Displacement Group 0"});const k=e.createShaderModule({code:at,label:"Wave Surface Displacement"});this.oceanSurfaceRasterizationPipeline=e.createRenderPipeline({layout:e.createPipelineLayout({bindGroupLayouts:[B,D,U]}),vertex:{module:k,entryPoint:"screenSpaceWarped"},fragment:{module:k,entryPoint:"rasterizationFragment",targets:[{format:a.colorWithSurfaceWorldDepthInAlpha},{format:a.normalWithSurfaceFoamStrengthInAlpha}]},primitive:{topology:"triangle-list",cullMode:"back",frontFace:"cw"},depthStencil:{format:a.depth,depthWriteEnabled:!0,depthCompare:"less"},label:"Wave Surface Displacement Surface Rasterization"})}record(e,t,a,i,n,o){this.settingsUBO.data.patch_world_half_extent=n.fft?100:300,this.settingsUBO.data.b_gerstner=n.gerstner,this.settingsUBO.data.b_displacement_map=n.fft,this.settingsUBO.data.foam_bias=n.foamBias,this.settingsUBO.data.gbuffer_extent=T.create(o.extent.width,o.extent.height),this.settingsUBO.data.foam_scale=n.foamScale,this.settingsUBO.writeToGPU(e.queue);const s=t.beginRenderPass({label:"Wave Surface Rasterization",colorAttachments:[{clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store",view:o.colorWithSurfaceWorldDepthInAlphaView},{clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store",view:o.normalWithSurfaceFoamStrengthInAlphaView}],depthStencilAttachment:{view:o.depthView,depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"store"},timestampWrites:a!==void 0?{querySet:a.querySet,beginningOfPassWriteIndex:a.beginWriteIndex,endOfPassWriteIndex:a.endWriteIndex}:void 0});s.setPipeline(this.oceanSurfaceRasterizationPipeline),s.setBindGroup(0,this.group0),s.setBindGroup(1,this.group1),s.setBindGroup(2,this.group2ByTurbulenceMapIndex[i]),s.setIndexBuffer(this.indices,"uint32"),s.drawIndexed(this.baseIndexCount,1),s.end()}}const nt=`// Call this in a render pass, passing in an index buffer [0, 1, 2, 0, 2, 3]
